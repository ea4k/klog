...
QT_MOC_LITERAL(1, 12, 12), // "addQSOToList"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4), // "_qso"
QT_MOC_LITERAL(4, 31, 10), // "queryError"
QT_MOC_LITERAL(5, 42, 15), // "_functionFailed"
QT_MOC_LITERAL(6, 58, 10), // "errorCodeS"
QT_MOC_LITERAL(7, 69, 11), // "nativeError"
QT_MOC_LITERAL(8, 81, 11) // "failedQuery"

    },
    "FileManager\0addQSOToList\0\0_qso\0"
    "queryError\0_functionFailed\0errorCodeS\0"
    "nativeError\0failedQuery"
};
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addQSOToList((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        ...
        {
            using _t = void (FileManager::*)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileManager::addQSOToList)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FileManager::*)(QString , QString , QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileManager::queryError)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void FileManager::addQSOToList(QStringList _t1)
{
...
// SIGNAL 1
void FileManager::queryError(QString _t1, QString _t2, QString _t3, QString _t4)
{
