...
#include <memory>
#include "../../src/widgets/map/mapwidget.h"
...
QT_MOC_LITERAL(1, 10, 11), // "doAddMarker"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8), // "latitude"
QT_MOC_LITERAL(4, 32, 9) // "longitude"

    },
    "MapWidget\0doAddMarker\0\0latitude\0"
    "longitude"
};
...
void MapWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doAddMarker((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MapWidget::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapWidget::doAddMarker)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MapWidget::doAddMarker(double _t1, double _t2)
{
