...
QT_MOC_LITERAL(1, 7, 10), // "queryError"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 14), // "functionFailed"
QT_MOC_LITERAL(4, 34, 10), // "errorCodeS"
QT_MOC_LITERAL(5, 45, 11), // "nativeError"
QT_MOC_LITERAL(6, 57, 11), // "failedQuery"
QT_MOC_LITERAL(7, 69, 16) // "awardDXCCUpdated"

    },
    "Awards\0queryError\0\0functionFailed\0"
...
void Awards::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->awardDXCCUpdated(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Awards::*)(QString , QString , QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Awards::queryError)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Awards::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Awards::awardDXCCUpdated)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Awards::queryError(QString _t1, QString _t2, QString _t3, QString _t4)
{
