        ...
        if (query.next())
        {
           //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId query next = OK" << endl;
            if (query.isValid())
            {
               ...
               //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId Date: " << aux << endl;
                dataC << aux;
                ...
                if (query2.next())
                {
                    ...
                    if (query2.isValid())
                    {
                       ...
                       //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId VALID OK2" << endl;
                        ...
                        dataC << (query2.value(7)).toString(); // Band is column 7
...
int DataProxy_SQLite::getDuplicatedQSOId(const QString &_qrz, const QString &_date, const int _band, const int _mode)
{
         //qDebug() << "DataProxy_SQLite::isThisQSODuplicated" << endl;
     QSqlQuery query;
     QString queryString;
