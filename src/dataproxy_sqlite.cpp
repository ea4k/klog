...
DataProxy_SQLite::DataProxy_SQLite(const QString &_parentFunction, const QString &_softVersion)
{
      ...
      //qDebug() << "DataProxy_SQLite::DataProxy_SQLite" << _softVersion << _parentFunction << Qt::endl;

       //qDebug() << "DataProxy_SQLite::DataProxy_SQLite 1" << Qt::endl;
    util = new Utilities();
    ...
    //dbCreated = db->createBandModeMaps();
       //qDebug() << "DataProxy_SQLite::DataProxy_SQLite - END" << Qt::endl;
    searching = false;
    executionN = 0;
...
DataProxy_SQLite::~DataProxy_SQLite(){
         //qDebug() << "DataProxy_SQLite::~DataProxy_SQLite" << Qt::endl;

}

int DataProxy_SQLite::getHowManyQSOPerPropMode(const QString &_p, const int _logn)
{
    //qDebug() << "DataProxy_SQLite::getHowManyQSOPerPropMode: " << _p << "/" << QString::number(_logn) << Qt::endl;
    ...
    //qDebug() << "DataProxy_SQLite::getHowManyQSOPerPropMode: queryString: " << queryString << Qt::endl;
    if (sqlOK)
    {
        query.next();
        if (query.isValid())
        {
            //qDebug() << "DataProxy_SQLite::getHowManyQSOPerPropMode: " << QString::number((query.value(0)).toInt()) << Qt::endl;
        ...
        {
            //qDebug() << "DataProxy_SQLite::getHowManyQSOPerPropModer: 0" << Qt::endl;
            query.finish();
            return 0;
        }
    }
    else
    {
        ...
        //qDebug() << "DataProxy_SQLite::getHowManyQSOPerPropMode: Query error" << Qt::endl;
        query.finish();
        return 0;
    }
}
...
{ //SELECT MAX (softversion) FROM softwarecontrol
    ...
    if (query.exec(stQuery))
    {
        ...
        if (query.isValid())
        {
            ...
            query.finish();
               //qDebug() << "DataProxy_SQLite::getSoftVersion: DATA: " << v << Qt::endl;
            if (v.length()<1)
            {
        ...
        {
            query.finish();
               //qDebug() << "DataProxy_SQLite::getSoftVersion: version empty-1"  << Qt::endl;
            return QString();
        }
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
           //qDebug() << "DataProxy_SQLite::getSoftVersion: version empty-1 - ERROR"  << Qt::endl;
        return QString();
    }
}
...
void DataProxy_SQLite::createLogModel(){
         //qDebug() << "DataProxy_SQLite::createLogModel" << Qt::endl;
}

void DataProxy_SQLite::createLogPanel(){
         //qDebug() << "DataProxy_SQLite::createLogPanel" << Qt::endl;
}

int DataProxy_SQLite::getIdFromModeName(const QString& _modeName)
{
      //qDebug() << "DataProxy_SQLite::getIdFromModeName: " << _modeName << "/" << QString::number(db->getModeIDFromName2(_modeName)) << Qt::endl;
...
{
      //qDebug() << "DataProxy_SQLite::getSubModeIdFromSubMode: " << _subModeName << Qt::endl;
...
{
    //qDebug() << "DataProxy_SQLite::getIdFromBandName: " << _bandName  << "/" << QString::number(db->getBandIDFromName2(_bandName))<< Qt::endl;
    if (_bandName.length()<1)
    {
            //qDebug() << "DataProxy_SQLite::getIdFromBandName:-4: " << _bandName  << "/" << QString::number(db->getBandIDFromName2(_bandName))<< Qt::endl;
        return -4;
    }
...
{
    //qDebug() << "DataProxy_SQLite::getNameFromBandId: " << QString::number(_id) << Qt::endl;
    return db->getBandNameFromID2(_id);
}

QString DataProxy_SQLite::getNameFromModeId (const int _id)
{
         //qDebug() << "DataProxy_SQLite::getNameFromModeId" << Qt::endl;
...
{
        //qDebug() << "DataProxy_SQLite::getNameFromSubModeId: " << QString::number(_id) << "DB: " << db->getModeNameFromID2(_id) << Qt::endl;
...
{
         //qDebug() << "DataProxy_SQLite::getSubModeFromId: " << QString::number(_id) << Qt::endl;
    QSqlQuery query;
...
{
    //qDebug() << "DataProxy_SQLite::getFreqFromBandId: " << QString::number(_id) << Qt::endl;
    return db->getFreqFromBandId(_id);
}

int DataProxy_SQLite::getBandIdFromFreq(const double _n)
{
          //qDebug() << "DataProxy_SQLite::getBandIdFromFreq: " << QString::number(_n) << Qt::endl;
    ...
    sqlOk = query.exec();
         ...
         //qDebug() << "DataProxy_SQLite::getBandIdFromFreq: Query: " << query.lastQuery() << Qt::endl;
    if (sqlOk)
    {
             //qDebug() << "DataProxy_SQLite::getBandIdFromFreq: Query OK" << Qt::endl;
        query.next();
    ...
    {
             //qDebug() << "DataProxy_SQLite::getBandIdFromFreq: Query NOK" << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return -2;
    }
...
{
       //qDebug() << "DataProxy_SQLite::getBandNameFromFreq: " << QString::number(_n) << Qt::endl;
    return getNameFromBandId(getBandIdFromFreq(_n));
}

double DataProxy_SQLite::getLowLimitBandFromBandName(const QString &_sm)
{
         //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandName: " << _sm << Qt::endl;
    if (_sm.length ()<2)
    {
        return -1.0;
    }
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            ...
            {
                     //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandName: -1.0-1" << Qt::endl;
                query.finish();
                return -1.0;
            }
            else
            {
                     //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandName(else): " << QString::number((query.value(0)).toDouble()) << Qt::endl;
        ...
        {
                 //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandName: -1.0-2" << Qt::endl;
            query.finish();
            return -1.0;
        }

             //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandName: -1.0-3" << Qt::endl;
        //query.finish();
        //return -1.0;
    }
    else
...
{
         //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandId" << Qt::endl;
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            ...
            {
                     //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandId: -1.0-1" << Qt::endl;
                query.finish();
                return -1.0;
            }
            else
            {
                     //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandId: " << QString::number((query.value(0)).toDouble()) << Qt::endl;
                double v = (query.value(0)).toDouble();
                query.finish();
                return v;
            }
        ...
        {
                 //qDebug() << "DataProxy_SQLite::getLowLimitBandFromBandId: -1.0-2" << Qt::endl;
            query.finish();
            return -1.0;
        }
...
{
    //qDebug() << Q_FUNC_INFO << ": " << _sm << Qt::endl;
    if (_sm.length ()<2)
    {
        return -1.0;
    }
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            if ( (query.value(0)).toDouble()<0 )
            {
                //qDebug() << Q_FUNC_INFO << ": -1.0-1" << Qt::endl;
                query.finish();
                return -1.0;
            }
            else
            {
                //qDebug() << Q_FUNC_INFO << ": (else): " << QString::number((query.value(0)).toDouble()) << Qt::endl;
                double v = (query.value(0)).toDouble();
                query.finish();
                return v;
            }
        ...
        {
            //qDebug() << Q_FUNC_INFO << ": -1.0-2" << Qt::endl;
            query.finish();
            return -1.0;
        }

        //qDebug() << Q_FUNC_INFO << ": -1.0-3" << Qt::endl;
        //query.finish();
        //return -1.0;
    }
    else
...
{
       //qDebug() << "DataProxy_SQLite::getBands - DEPRECATED please use getBandNames - TODO: Remove this function and change the calls" << Qt::endl;
    return getBandNames();
...
{
        //qDebug() << "DataProxy_SQLite::getBandNames" << Qt::endl;
    QStringList bands = QStringList();
    QSqlQuery query;
    QString queryString;
    bool sqlOK;
        ...
        while(query.next())
        {
            if (query.isValid())
            {
                queryString = (query.value(0)).toString();
                     //qDebug() << "DataProxy_SQLite::getBandNames: " << queryString << Qt::endl;
...
QStringList DataProxy_SQLite::sortBandNamesBottonUp(const QStringList _qs)
{
    //Receives a list of band names, sorts it from the lower band to the upper band and returns
      //qDebug() << "DataProxy_SQLite::sortBandNamesBottonUp: " << QString::number(_qs.length()) << Qt::endl;
    if (_qs.length()<2)
    {
        return _qs;
    }
    ...
    QStringList qs;
    qs.clear();
      //qDebug() << "DataProxy_SQLite::sortBandNamesBottonUp-00" << Qt::endl;

    for (int j=0; j<_qs.count(); j++)
    {
        map.insert(getLowLimitBandFromBandName(_qs.at(j)), _qs.at(j));
    }
      //qDebug() << "DataProxy_SQLite::sortBandNamesBottonUp-10" << Qt::endl;
    QMap<double, QString>::const_iterator i = map.constBegin();
      //qDebug() << "DataProxy_SQLite::sortBandNamesBottonUp-20" << Qt::endl;
    while (i != map.constEnd()) {
        qs << i.value();
        ++i;
    }

      //qDebug() << "DataProxy_SQLite::sortBandNamesBottonUp - END -lengh = " << QString::number(qs.length()) << Qt::endl;
    qs.removeDuplicates();
    return qs;
}
...
{
         //qDebug() << "DataProxy_SQLite::getBandIDs" << Qt::endl;
    QStringList bands = QStringList();
...
{
         //qDebug() << "DataProxy_SQLite::getBandsInLog: " << Qt::endl;
    QStringList bands = QStringList();
...
{
       //qDebug() << "DataProxy_SQLite::getModesInLog: " << Qt::endl;
    QStringList modes = QStringList();
    QString queryString = QString();
    if (_log <=0 )
    {
    ...
    query.finish();
        //qDebug() << "DataProxy_SQLite::getModesInLog: " << modes.join(" - ") << Qt::endl;
    modes.sort();
    return modes;
}
...
{
       //qDebug() << "DataProxy_SQLite::getMostUsedBand: " << Qt::endl;
    ...
    if (sqlOK)
    {
        if (query.next())
        {
            if (query.isValid())
            {
                int v = query.value(0).toInt();
                query.finish();
                   //qDebug() << "DataProxy_SQLite::getMostUsedBand-OK: " << QString::number(v)<< Qt::endl;
                return v;
            }
        }
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
           //qDebug() << "DataProxy_SQLite::getMostUsedBand-ERROR-1: " << Qt::endl;
        return -1;
    }
       //qDebug() << "DataProxy_SQLite::getMostUsedBand-ERROR-2: " << Qt::endl;
    return -2;
}

int DataProxy_SQLite::getMostUsedMode(const int _log)
{
      //qDebug() << "DataProxy_SQLite::getMostUsedMode: " << Qt::endl;
...
{
         //qDebug() << "DataProxy_SQLite::getLastQSOid" << Qt::endl;
    QSqlQuery query;
...
{
    //qDebug() << "DataProxy_SQLite::getFirstQSODateFromCall: " << _call << Qt::endl;
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            ...
            if (_date.isValid())
            {
                //qDebug() << "DataProxy_SQLite::getFirstQSODateFromCall: END OK"  << Qt::endl;
                return _date;
            }
            else
            {
                //qDebug() << "DataProxy_SQLite::getFirstQSODateFromCall: END-1 "  << Qt::endl;
                return QDate();
            }
        ...
        {
            query.finish();
            //qDebug() << "DataProxy_SQLite::getFirstQSODateFromCall: END-2"  << Qt::endl;
            return QDate();
        }
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        //qDebug() << "DataProxy_SQLite::getFirstQSODateFromCall: END-3"  << Qt::endl;
        return QDate();
    }
}
...
{
    //qDebug() << "DataProxy_SQLite::getLastQSODateFromCall: " << _call << Qt::endl;
    QSqlQuery query;
    QString stringQuery;
    QDate _date;
    if (util->isValidCall(_call))
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            ...
            if (_date.isValid())
            {
                //qDebug() << "DataProxy_SQLite::getLastQSODateFromCall: OK" << Qt::endl;
                return _date;
            }
            else
            {
                //qDebug() << "DataProxy_SQLite::getLastQSODateFromCall: END-1" << Qt::endl;
                return QDate();
            }
        ...
        {
            query.finish();
            //qDebug() << "DataProxy_SQLite::getLastQSODateFromCall: END-2" << Qt::endl;
            return QDate();
        }
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        //qDebug() << "DataProxy_SQLite::getLastQSODateFromCall: END-3" << Qt::endl;
        return QDate();
    }
}
...
{
         //qDebug() << "DataProxy_SQLite::clearLog" << Qt::endl;
    //int errorCode = 0;
    QSqlQuery query;
    ...
    if (sqlOK)
    {
             //qDebug() << "DataProxy_SQLite::clearLog: Log deleted!" << Qt::endl;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
             //qDebug() << "DataProxy_SQLite::clearLog: Log deleted FAILED" << Qt::endl;
        //errorCode = query.lastError().nativeErrorCode();

             //qDebug() << "DataProxy_SQLite::clearLog: LastQuery: " << query.lastQuery()  << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastError-data: " << query.lastError().databaseText()  << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastError-driver: " << query.lastError().driverText()  << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastError-n: " << QString::number(query.lastError().nativeErrorCode() ) << Qt::endl;
    }
    query.finish();
    ...
    if (sqlOK)
    {
             //qDebug() << "DataProxy_SQLite::clearLog: Awarddxcc deleted!" << Qt::endl;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
             //qDebug() << "DataProxy_SQLite::clearLog: Awarddxcc deletedFAILED" << Qt::endl;

             //qDebug() << "DataProxy_SQLite::clearLog - query error: " << QString::number(query.lastError().nativeErrorCode()) << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastQuery: " << query.lastQuery()  << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastError-data: " << query.lastError().databaseText()  << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastError-driver: " << query.lastError().driverText()  << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastError-n: " << QString::number(query.lastError().nativeErrorCode() ) << Qt::endl;
    ...
    {
             //qDebug() << "DataProxy_SQLite::clearLog: Awardwaz deleted!" << Qt::endl;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
             //qDebug() << "DataProxy_SQLite::clearLog: Awardwaz deleted FAILED" << Qt::endl;
        //errorCode = query.lastError().nativeErrorCode();
             //qDebug() << "DataProxy_SQLite::clearLog - query error: " << QString::number(query.lastError().nativeErrorCode()) << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastQuery: " << query.lastQuery()  << Qt::endl;
             //qDebug() << "DataProxy_SQLite::clearLog: LastError-data: " << query.lastError().databaseText()  << Qt::endl;
    ...
    if (query.isActive())
    {
             //qDebug() << "DataProxy_SQLite::clearLog: Query Active!" << Qt::endl;
        query.finish();
        return false;
    }
    else
    {
        query.prepare("VACUUM;");
             ...
             //qDebug() << "DataProxy_SQLite::clearLog: Query Not Active!" << Qt::endl;
        if (query.exec())
        {
                 //qDebug() << "DataProxy_SQLite::clearLog: VACUUM OK!" << Qt::endl;
            query.finish();
            return true;
        }
        else
        {
            emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
                 //qDebug() << "DataProxy_SQLite::clearLog: VACUUM FAILED" << Qt::endl;
            //errorCode = query.lastError().nativeErrorCode();
                 //qDebug() << "DataProxy_SQLite::clearLog - query error: " << QString::number(query.lastError().nativeErrorCode()) << Qt::endl;
                 //qDebug() << "DataProxy_SQLite::clearLog: LastQuery: " << query.lastQuery()  << Qt::endl;
                 //qDebug() << "DataProxy_SQLite::clearLog: LastError-data: " << query.lastError().databaseText()  << Qt::endl;
...
{
         //qDebug() << "DataProxy_SQLite::qslSentViaDirect" << Qt::endl;
    QSqlQuery query;
    QString queryString;
    queryString = QString("UPDATE log SET qsl_sent = 'Y', qsl_sent_via = 'D', qslsdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
         //qDebug() << "DataProxy_SQLite::qslSentViaDirect: " << queryString << Qt::endl;
    bool sqlOK = query.exec(queryString);
    query.finish();
    if (sqlOK)
    {
...
{
    //qDebug() << "DataProxy_SQLite::qslSentViaBureau" << Qt::endl;
    ...
    if (sqlOK)
    {
        //qDebug() << "DataProxy_SQLite::qslSentViaBureau - OK" << Qt::endl;
        return true;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        //qDebug() << "DataProxy_SQLite::qslSentViaBureau - NOK" << Qt::endl;
    }
...
{
         //qDebug() << "DataProxy_SQLite::" << QString::number (_qsoId) << "/" << _updateDate << Qt::endl;
    QSqlQuery query;
    QString queryString;
    ...
    if (sqlOK)
    {
             //qDebug() << "DataProxy_SQLite:: TRUE" << Qt::endl;
...
bool DataProxy_SQLite::qslRecViaBureau(const int _qsoId, const QDate &_updateDate, const bool _queueSentQSL)
{
    ...
    if  (_queueSentQSL)
    {
        ...
        if (sqlOK)
        {
            ...
            if (query.isValid())
            {
                ...
                if ((queryString == "Y") || (queryString == "R"))
                {
                    // NO ACTION REQUIRED, QSL IS ALREADY SENT
                          //qDebug() << "DataProxy_SQLite::qslRecViaBureau: QSL already requested" << Qt::endl;
                     //requestQSL = false;
                     queryString = QString("UPDATE log SET qsl_rcvd = 'Y', qsl_rcvd_via = 'B', qslrdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
                }
                else
                {
                         //qDebug() << "DataProxy_SQLite::qslRecViaBureau: Request QSL-1" << Qt::endl;
                    //requestQSL = true;
            ...
            {
                     //qDebug() << "DataProxy_SQLite::qslRecViaBureau: Request QSL-2" << Qt::endl;
                queryString = QString("UPDATE log SET qsl_rcvd = 'Y', qsl_rcvd_via = 'B', qsl_sent='R', qslrdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
                //requestQSL = true;
            }
        }
        ...
        {
                 //qDebug() << "DataProxy_SQLite::qslRecViaBureau: Request QSL-3" << Qt::endl;
            emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
            queryString = QString("UPDATE log SET qsl_rcvd = 'Y', qsl_rcvd_via = 'B', qsl_sent='R', qslrdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
            //requestQSL = true;
        }
    ...
    if (sqlOK)
    {
             //qDebug() << "DataProxy_SQLite::qslRecViaBureau TRUE" << Qt::endl;
        query.finish();
        //setDXCCAwardStatus(_qsoId);
        //setWAZAwardStatus(_qsoId);
    ...
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
         ...
         //qDebug() << "DataProxy_SQLite::qslRecViaBureau FALSE" << Qt::endl;
    query.finish();
    return false;
}
...
{
         //qDebug() << "DataProxy_SQLite::qslRecViaDirect" << Qt::endl;
    QSqlQuery query;
    QString queryString;
...
{
         //qDebug() << "DataProxy_SQLite::qslRecViaDirect: " << _updateDate << Qt::endl;
    QSqlQuery query;
    QString queryString;
    bool sqlOK;
    ...
    if  (_queueSentQSL)
    {
        ...
        if(sqlOK)
        {
            ...
            if (query.isValid())
            {
                ...
                {
                    // NO ACTION REQUIRED, QSL IS ALREADY SENT
                          //qDebug() << "DataProxy_SQLite::qslRecViaDirect: QSL already requested" << Qt::endl;
                     queryString = QString("UPDATE log SET qsl_rcvd = 'Y', qsl_rcvd_via = 'D', qslrdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
                }
                else
                {
                         //qDebug() << "DataProxy_SQLite::qslRecViaDirect: Request QSL-1" << Qt::endl;
            ...
            {
                     //qDebug() << "DataProxy_SQLite::qslRecViaDirect: Request QSL-2" << Qt::endl;
                queryString = QString("UPDATE log SET qsl_rcvd = 'Y', qsl_rcvd_via = 'D', qsl_sent='R', qslrdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
            }
        }
        else
        {
            emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
                 //qDebug() << "DataProxy_SQLite::qslRecViaDirect: Request QSL-3" << Qt::endl;
            queryString = QString("UPDATE log SET qsl_rcvd = 'Y', qsl_rcvd_via = 'D', qsl_sent='R', qslrdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
        }
    ...
    if (sqlOK)
    {
             //qDebug() << "DataProxy_SQLite::qslRecViaDirect TRUE" << Qt::endl;
        query.finish();
        //setDXCCAwardStatus(_qsoId);
        //setWAZAwardStatus(_qsoId);
        return true;
    ...
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
         ...
         //qDebug() << "DataProxy_SQLite::qslRecViaDirect FALSE" << Qt::endl;
    query.finish();
    return false;
}
...
bool DataProxy_SQLite::qslSentAsRequested(const int _qsoId, const QDate &_updateDate)
{
    //TODO: Add some protection to the data before modifying
         //qDebug() << "DataProxy_SQLite::qslSentAsRequested" << Qt::endl;
    QSqlQuery query;
    QString queryString;
    queryString = QString("UPDATE log SET qsl_sent = 'R', qslsdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
         //qDebug() << "DataProxy_SQLite::qslSentAsRequested: " << queryString << Qt::endl;
...
{
//TODO: Add some protection to the data before modifying
    //qDebug() << "DataProxy_SQLite::qslRecAsRequested" << Qt::endl;
    QSqlQuery query;
    QString queryString;
    queryString = QString("UPDATE log SET qsl_rcvd = 'R', qslsdate = '%1' WHERE id = '%2'").arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
         //qDebug() << "DataProxy_SQLite::qslRecAsRequested: " << queryString << Qt::endl;

    bool sqlOK = query.exec(queryString);

    if (sqlOK)
    {
        //qDebug() << "DataProxy_SQLite::qslRecAsRequested OK" << Qt::endl;
        query.finish();
        return true;
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::qslRecAsRequested NOK" << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
    }
    query.finish();
    return false;
...
{ // Updates the QSO with the ClubLog status & date
    ...
    queryString = QString("UPDATE log SET clublog_qso_upload_status = '%1', clublog_qso_upload_date = '%2' WHERE id = '%3'").arg(_st).arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
         //qDebug() << "DataProxy_SQLite::setClubLogSent: " << queryString << Qt::endl;
    bool sqlOK = query.exec(queryString);

    if (sqlOK)
    {
             //qDebug() << "DataProxy_SQLite::setClubLogSent - TRUE" << Qt::endl;
        query.finish();
        return true;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
         ...
         //qDebug() << "DataProxy_SQLite::setClubLogSent - FALSE" << Qt::endl;
    query.finish();
    return false;
}
...
bool DataProxy_SQLite::setLoTWQSLRec (const int _qsoId, const QString &_st, const QDate &_updateDate)
{
    ...
    queryString = QString("UPDATE log SET lotw_qsl_rcvd = '%1', lotw_qslrdate = '%2' WHERE id = '%3'").arg(_st).arg(util->getDateSQLiteStringFromDate(_updateDate)).arg(_qsoId);
         //qDebug() << "DataProxy_SQLite::setLoTWQSLRec: " << queryString << Qt::endl;
    bool sqlOK = query.exec(queryString);

    if (sqlOK)
    {
        //qDebug() << "DataProxy_SQLite::setLoTWQSLRec - TRUE" << Qt::endl;
        query.finish();
        return true;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
         ...
         //qDebug() << "DataProxy_SQLite::setLoTWQSLRec - FALSE" << Qt::endl;
    query.finish();
    return false;
}
...
bool DataProxy_SQLite::isQSLReceived(const int _qsoId)
{
         ...
         //qDebug() << "DataProxy_SQLite::isQSLReceived" << QString::number(_qsoId) << Qt::endl;
    QSqlQuery query;
    QString queryString;
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            ...
            if (queryString == "Y")
            {
                     //qDebug() << "DataProxy_SQLitew::isQSLReceived: " << QString::number(_qsoId) << "QSL Received" << Qt::endl;
                return true;
            }
            else
            {
                     //qDebug() << "DataProxy_SQLite::isQSLReceived: " << QString::number(_qsoId) << "QSL NOT Received-1" << Qt::endl;
                return false;
            }
        }
        else
        {
                 //qDebug() << "DataProxy_SQLite::isQSLReceived: " << QString::number(_qsoId) << "QSL NOT Received-2" << Qt::endl;
            query.finish();
            return false;
        }
    }
...
bool DataProxy_SQLite::isQSLSent(const int _qsoId)
{
         ...
         //qDebug() << "DataProxy_SQLite::isQSLSent: " << QString::number(_qsoId) << Qt::endl;
    QSqlQuery query;
    QString queryString;
    queryString = QString("SELECT qsl_sent FROM log WHERE id = '%1'").arg(_qsoId);
    bool sqlOK = query.exec(queryString);
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            ...
            if (queryString == "Y")
            {
                     //qDebug() << "DataProxy_SQLite::isQSLSent: " << QString::number(_qsoId) << "QSL Sent" << Qt::endl;
                return true;
            }
            else
            {
                     //qDebug() << "DataProxy_SQLite::isQSLSent: " << QString::number(_qsoId) << "QSL NOT Sent-1" << Qt::endl;
                return false;
            }
        }
        else
        {
                 //qDebug() << "DataProxy_SQLite::isQSLSent: " << QString::number(_qsoId) << "QSL NOT Sent-2" << Qt::endl;
            return false;
        }
    }
    else
...
{
         //qDebug() << "DataProxy_SQLite::getCallFromId" << Qt::endl;
    QSqlQuery query;
...
{
    //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: " << QString::number(_qsoId) << Qt::endl;
...
// To fix that we will do two queries, one to check if I have all the data and if not another one with a reduced scope.
    ...
    if (sqlOk)
    {
        //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: sqlOK -1" << Qt::endl;
        if (query.next())
        {
            //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: qsl next -1" << Qt::endl;
            if (query.isValid())
            {
                //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: sql valid -1" << Qt::endl;
                QSqlRecord rec = query.record();
                ...
                { // We DON'T have a band_rx available
                    query.finish();
                    //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: without BAND-RX" << Qt::endl;
            ...
            { // We have a band_rx available
                query.finish();
                //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: NO VALID" << Qt::endl;
                return QStringList();
            }
        }
        else
        {
            query.finish();
            //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: ERROR-1" << Qt::endl;
            return QStringList();
        }
    }
    else
    {
        query.finish();
        //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: ERROR-2" << Qt::endl;
        return QStringList();
    }
    ...
    //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: lastQuery: " << query.lastQuery() << Qt::endl;
    ...
    if (sqlOk)
    {
        ...
        if (query.next())
        {
            //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId query next = OK" << Qt::endl;
            if (query.isValid())
            {
                QSqlRecord rec = query.record();
                //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId query valid = OK" << Qt::endl;
                QString aux;
                ...
                {
                    query.finish();
                    //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: ERROR-3: " << aux << Qt::endl;
                    return QStringList();
                }
                dataC << aux;
               ...
               //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId Time_on: " << aux << Qt::endl;
                dataC << aux;
                ...
                {
                    query.finish();
                    //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: ERROR-5: " << aux << Qt::endl;
                    return QStringList();
                }
                ...
                {
                    query.finish();
                    //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: ERROR-7: " << aux << Qt::endl;
                    return QStringList();
                }
                dataC << aux;
                ...
                //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: RETURNING ... OK" << Qt::endl;
                query.finish();
                return dataC;
            }
            else
            {
                //NO VALID
                //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId NO VALID NOT OK" << Qt::endl;
                query.finish();
                return QStringList();
            }
        }
    ...
    {
        //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId NOT sqlOK" << Qt::endl;
        //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: 2 LastQuery: " << query.lastQuery()  << Qt::endl;
        //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: 2 LastError-data: " << query.lastError().databaseText()  << Qt::endl;
        //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: 2 LastError-driver: " << query.lastError().driverText()  << Qt::endl;
        //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: 2 LastError-n: " << QString::number(query.lastError().nativeErrorCode() ) << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return QStringList();
    }
    //qDebug() << "DataProxy_SQLite::getClubLogRealTimeFromId: ERROR-10" << Qt::endl;
    return QStringList();
}
...
QString DataProxy_SQLite::getNameFromQRZ(const QString &_call)
{
    if (_call.length() <= 0)
    {
        //qDebug() << "DataProxy_SQLite::getNameFromQRZ return 0" << Qt::endl;
        return QString();
    }
    ...
    if (sqlOk)
    {
        while (query.next())
        {
            if (query.isValid())
            {
                ...
                {
                    //qDebug() << "DataProxy_SQLite::getNameFromQRZ: " <<  (query.value(0)).toString() << Qt::endl;
                    QString v = (query.value(0)).toString();
                    query.finish();
                    return v;
                }
        ...
        query.finish();
        //qDebug() << "DataProxy_SQLite::getNameFromQRZ: NO NAME"  << Qt::endl;
        return QString();
    }
    else
    {
...
{
       //qDebug() << "DataProxy_SQLite::updateAwardDXCC" << Qt::endl;
    fillEmptyDXCCInTheLog();
    return db->updateAwardDXCCTable();
       //qDebug() << "DataProxy_SQLite::updateAwardDXCC-END" << Qt::endl;
}

bool DataProxy_SQLite::updateAwardWAZ()
{
       //qDebug() << "DataProxy_SQLite::updateAwardWAZ" << Qt::endl;
    return db->updateAwardWAZTable();
}

bool DataProxy_SQLite::QRZCOMModifyFullLog(const int _currentLog)
{
    //qDebug() << " DataProxy_SQLite::QRZCOMModifyFullLog" << QString::number(_currentLog) << Qt::endl;
   ...
   if (sqlOK)
   {
       //qDebug() << " DataProxy_SQLite::QRZCOMModifyFullLog: END TRUE" << Qt::endl;
       return true;
   }
   else
   {
       emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
       //qDebug() << " DataProxy_SQLite::QRZCOMModifyFullLog: END FALSE: " << query.lastError().databaseText()  << Qt::endl;
       return false;
   }
...
{
    //qDebug() << " DataProxy_SQLite::QRZCOMSentQSOs" << QString::number(_qsos.count()) << Qt::endl;
    if (_qsos.count() < 1)
    {
        return true;
    }
    ...
    {
          //qDebug() << " DataProxy_SQLite::QRZCOMLSentQSOs: updating QSO: " << QString::number(_qsos.at(i)) << Qt::endl;
         ...
         if (sqlOK)
         {
              //qDebug() << " DataProxy_SQLite::QRZCOMSentQSOs: exec: " << query.lastQuery() << Qt::endl;
         }
         else
         {
             emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
               //qDebug() << " DataProxy_SQLite::QRZCOMSentQSOs: END FALSE"  << Qt::endl;
             return false;
         }
    }
      //qDebug() << " DataProxy_SQLite::QRZCOMSentQSOs: END TRUE"  << Qt::endl;
    return true;
}
...
{
    //qDebug() << " DataProxy_SQLite::clublogSentQSOs" << QString::number(_qsos.count()) << Qt::endl;
    if (_qsos.count() < 1)
    {
        return true;
    }
    ...
    for (int i = 0; i< _qsos.count(); i++)
    {
          //qDebug() << " DataProxy_SQLite::lotwSentQSOs: updating QSO: " << QString::number(_qsos.at(i)) << Qt::endl;
         ...
         if (sqlOK)
         {
              //qDebug() << " DataProxy_SQLite::clublogSentQSOs: exec: " << query.lastQuery() << Qt::endl;
         }
         else
         {
             emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
               //qDebug() << " DataProxy_SQLite::clublogSentQSOs: END FALSE"  << Qt::endl;
             return false;
         }
    }
      //qDebug() << " DataProxy_SQLite::clublogSentQSOs: END TRUE"  << Qt::endl;
    return true;
}

bool DataProxy_SQLite::clublogModifyFullLog(const int _currentLog)
 {
     //qDebug() << " DataProxy_SQLite::clublogModifyFullLog" << QString::number(_currentLog) << Qt::endl;
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        //qDebug() << " DataProxy_SQLite::clublogModifyFullLog: END FALSE"  << Qt::endl;
        return false;
    }

       //qDebug() << " DataProxy_SQLite::clublogModifyFullLog: END TRUE"  << Qt::endl;
    //return false;
 }

 bool DataProxy_SQLite::eQSLModifyFullLog(const int _currentLog)
 {
     //qDebug() << " DataProxy_SQLite::eQSLModifyFullLog" << QString::number(_currentLog) << Qt::endl;
    ...
    if (sqlOK)
    {
        //qDebug() << " DataProxy_SQLite::eQSLModifyFullLog: END TRUE" << Qt::endl;
        return true;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        //qDebug() << " DataProxy_SQLite::eQSLModifyFullLog: END FALSE: " << query.lastError().databaseText()  << Qt::endl;
        return false;
    }
 ...
 {
     //qDebug() << " DataProxy_SQLite::eQSLSentQSOs" << QString::number(_qsos.count()) << Qt::endl;
     if (_qsos.count() < 1)
     {
         return true;
     }
     ...
     for (int i = 0; i< _qsos.count(); i++)
     {
           //qDebug() << " DataProxy_SQLite::eQSLSentQSOs: updating QSO: " << QString::number(_qsos.at(i)) << Qt::endl;
          ...
          if (sqlOK)
          {
               //qDebug() << " DataProxy_SQLite::eQSLSentQSOs: exec: " << query.lastQuery() << Qt::endl;
          }
          else
          {
              emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
                //qDebug() << " DataProxy_SQLite::eQSLSentQSOs: END FALSE"  << Qt::endl;
              return false;
          }
     }
       //qDebug() << " DataProxy_SQLite::eQSLSentQSOs: END TRUE"  << Qt::endl;
     return true;
 }
...
{
    //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: " << _dxcall << Qt::endl;
...
*/
    ...
    {
        //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: Error: call" << Qt::endl;
        return false;
    }

    if (_datetime.isValid())
    {
        //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: time-on: " <<  _datetime << Qt::endl;
        ...
        //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: time-on: " << stringData << Qt::endl;
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: Error: time-on_ " << _datetime << Qt::endl;
        return false;
    }
    ...
    if (band != _band)
    {
        //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: Error: FREQ / BAND inconsistency " << _band << "/" << QString::number(_freq) << Qt::endl;
    }
    ...
    {
           //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: Error: band" << Qt::endl;
    ...
    int _modeid = getSubModeIdFromSubMode(_mode);
       //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: mode: " << _mode << Qt::endl;
       //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: modeid: " << QString::number(_modeid) << Qt::endl;
    ...
    {
           //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: Error: mode" << Qt::endl;
...
*/
    ...
    //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: Query: " << stringQuery << Qt::endl;

    bool sqlOK = query.exec(stringQuery);

    //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: LastQuery: " << query.lastQuery() << Qt::endl;

    if (sqlOK)
    {
        query.finish();
        //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: SQL OK" << Qt::endl;
        return true;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        //qDebug() << "DataProxy_SQLite::addQSOFromWSJTX: Error: SQL " << Qt::endl;
        return false;
    }
...
{
    //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: " << _call << Qt::endl;
...
*/
    ...
    {
        //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: Error: call" << Qt::endl;
        return -1;
    }

    if (_datetime.isValid())
    {
        //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: time-on: " <<  _datetime << Qt::endl;
        stringFields  = stringFields  + "qso_date, ";
        QDateTime _dateTime;
        stringData =  stringData + "'" + util->getDateTimeSQLiteStringFromDateTime(_datetime) + "', ";
        //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: time-on: " << stringData << Qt::endl;
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: Error: time-on_ " << _datetime << Qt::endl;
        return -2;
    }
    ...
    if (band != _band)
    {
        //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: Error: FREQ / BAND inconsistency " << _band << "/" << QString::number(_freq) << Qt::endl;
    }
    ...
    {
           //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: Error: band" << Qt::endl;
    ...
    {
           //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: Error: mode" << Qt::endl;
        emit queryError(Q_FUNC_INFO, "Incorrect mode: " + _mode, "-1000", "No query error");
        return -4;
    }
    ...
    stringQuery = "INSERT INTO log (" + stringFields  + ") values (" + stringData +")" ;
    //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: Query: " << stringQuery << Qt::endl;

    bool sqlOK = query.exec(stringQuery);

    //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: LastQuery: " << query.lastQuery() << Qt::endl;
    ...
    if (sqlOK)
    {
        ...
        if (query.exec("SELECT MAX(id) FROM log"))
        {
            if (query.next())
            {
                ...
                {
                    //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: NOT VALID" << Qt::endl;
                }
            }
            else
            {
                //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: QUERY EXEC NOT NEXT" << Qt::endl;

            }
        }
        else
        {
            //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: NOT OK: " << query.lastError().databaseText() << Qt::endl;
            //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: NOT OK: " << QString::number(query.lastError().nativeErrorCode()) << Qt::endl;
        }
        //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: SQL OK" << Qt::endl;
        return -5;
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        //qDebug() << "DataProxy_SQLite::addQSOFromLoTW: Error: SQL " << Qt::endl;
        return -100;
    }
...
{
         //qDebug() << "DataProxy_SQLite::deleteQSO" << Qt::endl;
    QSqlQuery query;
...
{
         //qDebug() << "DataProxy_SQLite::isWorkedB4" << Qt::endl;
    //Returns the QSO id
    QSqlQuery query;
    QString queryString;
    if (_currentLog < 0)
...
//QList<int> DataProxy_SQLite::isThisQSODuplicated(const QString &_qrz, const QDateTime &_dateTime, const int _band, const int _mode)
{
        ...
        //qDebug() << "DataProxy_SQLite::isThisQSODuplicated" << Qt::endl;
    QSqlQuery query;
    QString queryString;
    QList<int> dupeQsos;
    dupeQsos.clear();
    ...
    if (sqlOK)
    {
        while (query.next())
        {
            ...
            {
                   //qDebug() << "DataProxy_SQLite::isThisQSODuplicated - not valid"  << Qt::endl;
            }
        }
        return dupeQsos;
    }
...
{
        //qDebug() << "DataProxy_SQLite::isDXCCConfirmed: " << QString::number(_dxcc) << "/" << QString::number(_currentLog) << Qt::endl;
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            if ( (query.value(0)).toInt() == 1)
            {
                    //qDebug() << "DataProxy_SQLite::isDXCCConfrmed: TRUE" << Qt::endl;
                query.finish();
                return true;
            }
            else
            {
                    //qDebug() << "DataProxy_SQLite::isDXCCConfrmed: FALSE1" << Qt::endl;
                query.finish();
                return false;
            }
        }
        ...
        {
                //qDebug() << "DataProxy_SQLite::isDXCCConfrmed: FALSE2" << Qt::endl;
            query.finish();
            return false;
        }
    }
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
            //qDebug() << "DataProxy_SQLite::isDXCCConfrmed: FALSE3" << Qt::endl;
        query.finish();
        return false;
    }
}
...
{// 160M is considered as HF
    ...
    {
            //qDebug() << "DataProxy_SQLite::isHF: TRUE" << Qt::endl;
        return true;
    }
    else
    {
            //qDebug() << "DataProxy_SQLite::isHF: FALSE" << Qt::endl;
        return false;
    }
}
...
bool DataProxy_SQLite::isWARC(const int _band)
{
    ...
    {
             //qDebug() << "DataProxy_SQLite::isWARC: tRUE" << Qt::endl;
        return true;
    }
    else
    {
             //qDebug() << "DataProxy_SQLite::isWARC: FALSE" << Qt::endl;
        return false;
    }
}
...
bool DataProxy_SQLite::isVHF(const int _band)
{
    ...
    {
            //qDebug() << "DataProxy_SQLite::isVHF: TRUE" << Qt::endl;
        return true;
    }
    else
    {
            //qDebug() << "DataProxy_SQLite::isVHF: FALSE" << Qt::endl;
        return false;
    }
}
...
bool DataProxy_SQLite::isUHF(const int _band)
{
    ...
    {
            //qDebug() << "DataProxy_SQLite::isUHF: TRUE" << Qt::endl;
        return true;
    }
    else
    {
            //qDebug() << "DataProxy_SQLite::isUHF: FALSE" << Qt::endl;
        return false;
    }
}
...
{
       //qDebug() << "DataProxy_SQLite::getYearsOperating: " << QString::number(_currentLog) << Qt::endl;
    ...
    QString year = QString();
       //qDebug() << "DataProxy_SQLite::getYearsOperating: -1" << Qt::endl;
    bool sqlOk = query.exec(queryString);

    if (sqlOk)
    {
           //qDebug() << "DataProxy_SQLite::getYearsOperating: sqlOk = true" << Qt::endl;
        while (query.next())
        {
            if (query.isValid())
            {
                year = (query.value(0)).toString();
                   //qDebug() << "DataProxy_SQLite::getYearsOperating: year=" << year << Qt::endl;
                years << year;
                year.clear();
            }
            else
            {
                   //qDebug() << "DataProxy_SQLite::getYearsOperating: NOT VALID"  << Qt::endl;
            }
        }
           //qDebug() << "DataProxy_SQLite::getYearsOperating: END OK - " << QString::number(years.size())<< Qt::endl;
        query.finish();
        //return years;
        if (years.length()>0)
        {
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
             //qDebug() << "DataProxy_SQLite::getYearsOperating: sqlOk = false" << Qt::endl;
    }
    return years;
}
...
{// Mark LOTW QSL SENT as Q (Queued)
    // If currentLog <0 ALL the QSO of the log will be queued
       ...
       //qDebug() << "DataProxy_SQLite::lotwSentQueue: Date:" << _updateDate << " /" << QString::number(_currentLog) << Qt::endl;
    QString queryString;
...
{// Mark LOTW QSL SENT as Q (Queued)
    // If currentLog <0 ALL the QSO of the log will be queued
       ...
       //qDebug() << "DataProxy_SQLite::lotwSentQueue: " << QString::number(_currentLog) << Qt::endl;
    QString queryString;
...
{
      //qDebug() << " DataProxy_SQLite::lotwSentQSOs" << QString::number(_qsos.count()) << Qt::endl;
    if (_qsos.count() < 1)
    {
        return true;
    }
    ...
    for (int i = 0; i< _qsos.count(); i++)
    {
         ...
         if (sqlOK)
         {
              //qDebug() << " DataProxy_SQLite::lotwSentQSOs: exec: " << query.lastQuery() << Qt::endl;
         }
         else
         {
             emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
               //qDebug() << " DataProxy_SQLite::lotwSentQSOs: END FALSE"  << Qt::endl;
             return false;
         }
    }
      //qDebug() << " DataProxy_SQLite::lotwSentQSOs: END TRUE"  << Qt::endl;
    return true;
}
...
{ //Returns the QSO id updated or -1 if none was updated.
   //qDebug() << " DataProxy_SQLite::lotwUpdateQSLReception: " << _call << "/" << util->getDateTimeSQLiteStringFromDateTime(_dateTime) << "/" <<_band <<"/"<<_mode << "/" << util->getADIFDateFromQDate(_qslrdate)  << endl ;
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            ...
            if (( id > 0) && (_lotwQSLReceived!="Y"))
            {
                ...
                if (sqlOK)
                {
                   //qDebug() << "DataProxy_SQLite::lotwUpdateQSLReception: Modified Id: " << QString::number(id) << Qt::endl;
                    return id;
                }
                else
                {
                    emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
                   //qDebug() << "DataProxy_SQLite::lotwUpdateQSLReception: SQL ERROR" << Qt::endl;
                    return -4;
                }
            }
            else
            {
               //qDebug() << "DataProxy_SQLite::lotwUpdateQSLReception ID Not found" << Qt::endl;
                query.finish();
                return -5;
            }
        }
        ...
        {
           //qDebug() << "DataProxy_SQLite::lotwUpdateQSLReception QSO not found " << query.lastQuery() << Qt::endl;
            return -1;
        }
        else
        {
           //qDebug() << "DataProxy_SQLite::lotwUpdateQSLReception Unknown error " << query.lastQuery() << Qt::endl;
           //qDebug() << "DataProxy_SQLite::lotwUpdateQSLReception Error: " << query.lastError().databaseText() << Qt::endl;
           //qDebug() << "DataProxy_SQLite::lotwUpdateQSLReception Error: " << QString::number(query.lastError().nativeErrorCode()) << Qt::endl;
            query.finish();
            return -3;
        }
    }
    ...
    {
       //qDebug() << "DataProxy_SQLite::lotwUpdateQSLReception Query error: " << query.lastQuery() << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
    }
    query.finish();
    return -100;
...
{
    //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent Call/Start/end: " << _stationCallsign << _startDate.toString("yyyyMMdd") << "/" << _endDate.toString("yyyyMMdd") << Qt::endl;
    ...
    if (_justQueued)
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent justQueued TRUE" << Qt::endl;
        _query_justQueued = QString("lotw_qsl_sent='Q'");
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent justQueued FALSE" << Qt::endl;
    ...
    */
    ...
    bool sqlOK = query.exec(queryString);
    //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent Query: " << query.lastQuery() << Qt::endl;
       ...
       // //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent Query: " << query.lastQuery() << Qt::endl;
        ...
        while ( (query.next())) {
            if (query.isValid())
            {
                ...
                //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent QSO Date: " << aux << "/" << tmpDate.toString("yyyy-MM-dd") << Qt::endl;
...
{
    //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent2 Call/Start/end: " << _stationCallsign << _startDate.toString("yyyyMMdd") << "/" << _endDate.toString("yyyyMMdd") << Qt::endl;
    QStringList list;
    list.clear();
       ...
       // //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent Query: " << query.lastQuery() << Qt::endl;
        ...
        while ( (query.next())) {
            if (query.isValid())
            {
                ...
                //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent2 - date: " << date << Qt::endl;
                //qDebug() << "DataProxy_SQLite::getQSOsListLoTWNotSent2 - time: " << time << Qt::endl;
...
{
    //qDebug() << "DataProxy_SQLite::getQSOsListClubLogToSent Call/Start/end: " << _stationCallsign << _startDate.toString("yyyyMMdd") << "/" << _endDate.toString("yyyyMMdd") << Qt::endl;
    ...
    if (_justModified)
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListClubLogToSent justQueued TRUE" << Qt::endl;
        _query_justModified = QString("clublog_qso_upload_status='M'");
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListClubLogToSent justQueued FALSE" << Qt::endl;
        _query_justModified = QString("clublog_qso_upload_status!='M'");
    }
    ...
    bool sqlOK = query.exec(queryString);
    //qDebug() << "DataProxy_SQLite::getQSOsListClubLogToSent Query: " << query.lastQuery() << Qt::endl;
       ...
       // //qDebug() << "DataProxy_SQLite::getQSOsListClubLogToSent Query: " << query.lastQuery() << Qt::endl;
        ...
        while ( (query.next())) {
            if (query.isValid())
            {
                ...
                aux = (query.value(1)).toString() ;
                tmpDate = util->getDateFromSQliteString(aux);
                //qDebug() << "DataProxy_SQLite::getQSOsListClubLogToSent QSO Date: " << aux << "/" << tmpDate.toString("yyyy-MM-dd") << Qt::endl;
                //tmpDate = QDate::fromString(aux, "yyyy-MM-dd");
                if ((_startDate<=tmpDate) && _endDate>=tmpDate)
                {
                    //qDebug() << "DataProxy_SQLite::getQSOsListClubLogToSent Adding: "  << QString::number((query.value(0)).toInt()) << Qt::endl;
                    qsoList.append((query.value(0)).toInt());
                }
            }
            else
    ...
    query.finish();
    qs.sort();
    //qDebug() << "DataProxy_SQLite::getQSOsListClubLogToSent Returning: #"  << QString::number(qsoList.length()) << Qt::endl;
    return qsoList;
}
...
{
    //qDebug() << "DataProxy_SQLite::getQSOsListEQSLToSent Call/Start/end: " << _stationCallsign << _startDate.toString("yyyyMMdd") << "/" << _endDate.toString("yyyyMMdd") << Qt::endl;
    ...
    if (_justModified)
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListEQSLToSent justQueued TRUE" << Qt::endl;
        _query_justModified = QString("eqsl_qsl_sent='Q'");
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListEQSLToSent justQueued FALSE" << Qt::endl;
    ...
    bool sqlOK = query.exec(queryString);
    //qDebug() << "DataProxy_SQLite::getQSOsListEQSLToSent Query: " << query.lastQuery() << Qt::endl;
       ...
       // //qDebug() << "DataProxy_SQLite::getQSOsListEQSLToSent Query: " << query.lastQuery() << Qt::endl;
        ...
        while ( (query.next())) {
            if (query.isValid())
            {
                ...
                aux = (query.value(1)).toString() ;
                tmpDate = util->getDateFromSQliteString(aux);
                //qDebug() << "DataProxy_SQLite::getQSOsListEQSLToSent QSO Date: " << aux << "/" << tmpDate.toString("yyyy-MM-dd") << Qt::endl;
                //tmpDate = QDate::fromString(aux, "yyyy-MM-dd");
                if ((_startDate<=tmpDate) && _endDate>=tmpDate)
                {
                    qsoList.append((query.value(0)).toInt());
...
{
    //qDebug() << "DataProxy_SQLite::QList<int> getQSOsListQRZCOMToSent(const QString &_stationCallsign, const QDate &_startDate, const QDate &_endDate, bool _justModified=true); Call/Start/end: " << _stationCallsign << _startDate.toString("yyyyMMdd") << "/" << _endDate.toString("yyyyMMdd") << Qt::endl;
    ...
    if (_justModified)
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListQRZCOMToSent justQueued TRUE" << Qt::endl;
        _query_justModified = QString("qrzcom_qso_upload_status='M'");
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListQRZCOMToSent justQueued FALSE" << Qt::endl;
    ...
    bool sqlOK = query.exec(queryString);
    //qDebug() << "DataProxy_SQLite::getQSOsListQRZCOMToSent Query: " << query.lastQuery() << Qt::endl;
       ...
       // //qDebug() << "DataProxy_SQLite::getQSOsListQRZCOMToSent Query: " << query.lastQuery() << Qt::endl;
        ...
        while ( (query.next())) {
            if (query.isValid())
            {
                ...
                aux = (query.value(1)).toString() ;
                tmpDate = util->getDateFromSQliteString(aux);
                //qDebug() << "DataProxy_SQLite::getQSOsListQRZCOMToSent QSO Date: " << aux << "/" << tmpDate.toString("yyyy-MM-dd") << Qt::endl;
                //tmpDate = QDate::fromString(aux, "yyyy-MM-dd");
                if ((_startDate<=tmpDate) && _endDate>=tmpDate)
                {
                    qsoList.append((query.value(0)).toInt());
...
{
    qDebug() << Q_FUNC_INFO << ": Call/Start/end: " << _stationCallsign << _startDate.toString("yyyyMMdd") << "/" << _endDate.toString("yyyyMMdd") << Qt::endl;
    QList <int> qsoList;
    qsoList.clear();
    QDate tmpDate;
    QString aux = QString();
    ...
    bool sqlOK = query.exec(queryString);
    //qDebug() << Q_FUNC_INFO << ": Query: " << query.lastQuery() << Qt::endl;
       ...
       // //qDebug() << Q_FUNC_INFO << ": Query: " << query.lastQuery() << Qt::endl;
        ...
        while ( (query.next())) {
            if (query.isValid())
            {
                ...
                aux = (query.value(1)).toString() ;
                tmpDate = util->getDateFromSQliteString(aux);
                //qDebug() << Q_FUNC_INFO << ": QSO Date: " << aux << "/" << tmpDate.toString("yyyy-MM-dd") << Qt::endl;
                //tmpDate = QDate::fromString(aux, "yyyy-MM-dd");
                if ((_startDate<=tmpDate) && _endDate>=tmpDate)
                {
                    qsoList.append((query.value(0)).toInt());
...
{
    //qDebug() << "DataProxy_SQLite::getQSOsListeQSLNotSent Call/Start/end: " << _stationCallsign << _startDate.toString("yyyyMMdd") << "/" << _endDate.toString("yyyyMMdd") << Qt::endl;
    ...
    if (_justQueued)
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListeQSLNotSent justQueued TRUE" << Qt::endl;
        _query_justQueued = QString("eqsl_qsl_sent='Q'");
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::getQSOsListeQSLNotSent justQueued FALSE" << Qt::endl;
    ...
    bool sqlOK = query.exec(queryString);
    //qDebug() << "DataProxy_SQLite::getQSOsListeQSLNotSent Query: " << query.lastQuery() << Qt::endl;
...
{ //Returns QRZ << date+time << Band (txt) << mode (txt)
    //qDebug() << "DataProxy_SQLite::getQSODetailsForLoTWDownload" << QString::number(_id) << Qt::endl;
    QStringList result;
    result.clear();
    //getNameFromBandId
    QSqlQuery query;
    ...
    if (sqlOk)
    {
        if (query.next())
        {
            if (query.isValid())
            {
                ...
                query.finish();
                //qDebug() << "DataProxy_SQLite::getQSODetailsForLoTWDownload - date: " << date << Qt::endl;
                //qDebug() << "DataProxy_SQLite::getQSODetailsForLoTWDownload - time: " << time << Qt::endl;
                ...
                result.append(bandid);
                result.append(modeid);
                //qDebug() << "DataProxy_SQLite::getQSODetailsForLoTWDownload - END: call: " << call << Qt::endl;
                return result;
            }
            //qDebug() << "DataProxy_SQLite::getQSODetailsForLoTWDownload - END: no valid "  << Qt::endl;
        }
        query.finish();
        //qDebug() << "DataProxy_SQLite::getQSODetailsForLoTWDownload - END: no next "  << Qt::endl;
        return result;
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::getQSODetailsForLoTWDownload - END: SQL NOK "  << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return result;
    }
...
{
       //qDebug() << "DataProxy_SQLite::getQSOonYear: " << QString::number(_year) << "/" << QString::number(_logNumber) << Qt::endl;
    ...
    sqlOK = query.exec(queryString);
         ...
         //qDebug() << "DataProxy_SQLite::getQSOonYear: queryString: " << queryString << Qt::endl;
    if (sqlOK)
    {
        query.next();
        if (query.isValid())
        {
                 //qDebug() << "DataProxy_SQLite::getQSOonYear: " << QString::number((query.value(0)).toInt()) << Qt::endl;
            int v = (query.value(0)).toInt();
            query.finish();
            return v;
        }
        ...
        {
                 //qDebug() << "DataProxy_SQLite::getQSOonYear: 0" << Qt::endl;
            query.finish();
            return 0;
        }
    }
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
             //qDebug() << "DataProxy_SQLite::getDXCConYear: Query error" << Qt::endl;
        query.finish();
        return 0;
    }
}
...
{
         //qDebug() << "DataProxy_SQLite::getDXCConYear: " << QString::number(_year) << "/" << QString::number(_logNumber) << Qt::endl;
    ...
    sqlOK = query.exec(queryString);
         ...
         //qDebug() << "DataProxy_SQLite::getDXCConYear: queryString: " << queryString << Qt::endl;
    if (sqlOK)
    {
        query.next();
        if (query.isValid())
        {
                 //qDebug() << "DataProxy_SQLite::getDXCConYear: " << QString::number((query.value(0)).toInt()) << Qt::endl;
            int v = (query.value(0)).toInt();
            query.finish();
            return v;
        }
        ...
        {
                 //qDebug() << "DataProxy_SQLite::getDXCConYear: 0" << Qt::endl;
            query.finish();
            return 0;
        }
    }
...
{
         //qDebug() << "DataProxy_SQLite::getCQzonYear: " << QString::number(_year) << Qt::endl;
    QSqlQuery query;
    QString queryString;
    bool sqlOK;
    if (_logNumber < 0)
    ...
    sqlOK = query.exec(queryString);
         ...
         //qDebug() << "DataProxy_SQLite::getCQzonYear: queryString: " << queryString << Qt::endl;
    if (sqlOK)
    {
        query.next();
        if (query.isValid())
        {
                 //qDebug() << "DataProxy_SQLite::getCQzonYear: " << QString::number((query.value(0)).toInt()) << Qt::endl;
            int v = (query.value(0)).toInt();
            query.finish();
            return v;
        }
        ...
        {
            //qDebug() << "DataProxy_SQLite::getCQzonYear: 0" << Qt::endl;
            query.finish();
            return 0;
        }
    }
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
             //qDebug() << "DataProxy_SQLite::getCQzonYear: Query error" << Qt::endl;
        query.finish();
        return 0;
    }
}
...
int DataProxy_SQLite::getQSOsWithDXCC(const int _dxcc, const int _logNumber)
{
     ...
     //qDebug() << "DataProxy_SQLite::getQSOsWithDXCC: " << QString::number(_dxcc) << Qt::endl;
  QSqlQuery query;
  QString queryString;
  bool sqlOK;
  if (_logNumber < 0)
  ...
  sqlOK = query.exec(queryString);
       ...
       //qDebug() << "DataProxy_SQLite::getQSOsWithDXCC: queryString: " << queryString << Qt::endl;
  if (sqlOK)
  {
      query.next();
      if (query.isValid())
      {
               //qDebug() << "DataProxy_SQLite::getQSOsWithDXCC: " << QString::number((query.value(0)).toInt()) << Qt::endl;
          int v = (query.value(0)).toInt();
          query.finish();
          return v;
      }
      ...
      {
               //qDebug() << "DataProxy_SQLite::getQSOsWithDXCC: 0" << Qt::endl;
          query.finish();
          return 0;
      }
  ...
  {
      emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
           //qDebug() << "DataProxy_SQLite::getQSOsWithDXCC: Query error" << Qt::endl;
      query.finish();
      return 0;
  }
}
...
{
     //qDebug() << "DataProxy_SQLite::getQSOsAtHour: " << QString::number(_hour) << Qt::endl;
  QSqlQuery query;
  QString queryString;
  bool sqlOK;
  QString aux = QString();
  ...
  sqlOK = query.exec(queryString);
       ...
       //qDebug() << "DataProxy_SQLite::getQSOsAtHour: queryString: " << queryString << Qt::endl;
  if (sqlOK)
  {
      query.next();
      if (query.isValid())
      {
               //qDebug() << "DataProxy_SQLite::getQSOsAtHour: " << QString::number((query.value(0)).toInt()) << Qt::endl;
          int v = (query.value(0)).toInt();
          query.finish();
          return v;
      }
      ...
      {
               //qDebug() << "DataProxy_SQLite::getQSOsAtHour: 0" << Qt::endl;
          query.finish();
          return 0;
      }
  }
  ...
  {
      emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
           //qDebug() << "DataProxy_SQLite::getQSOsAtHour: Query error" << Qt::endl;
      query.finish();
      return 0;
  }
}
...
{
      //qDebug() << "DataProxy_SQLite::getQSOsAtHourOnBand: " << QString::number(_hour) << Qt::endl;
   QSqlQuery query;
   QString queryString;
   bool sqlOK;
   QString aux = QString();
   ...
   sqlOK = query.exec(queryString);
        ...
        //qDebug() << "DataProxy_SQLite::getQSOsAtHourOnBand: queryString: " << queryString << Qt::endl;
   if (sqlOK)
   {
       query.next();
       if (query.isValid())
       {
                //qDebug() << "DataProxy_SQLite::getQSOsAtHourOnBand: " << QString::number((query.value(0)).toInt()) << Qt::endl;
           int v = (query.value(0)).toInt();
           query.finish();
           return v;
       }
       ...
       {
                //qDebug() << "DataProxy_SQLite::getQSOsAtHourOnBand: 0" << Qt::endl;
           query.finish();
           return 0;
       }
   }
   ...
   {
       emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
            //qDebug() << "DataProxy_SQLite::getQSOsAtHourOnBandç: Query error" << Qt::endl;
       query.finish();
       return 0;
   }
}
...
{
       //qDebug() << "DataProxy_SQLite::getgetQSOsOnMonth: " << QString::number(_month) << Qt::endl;
    QSqlQuery query;
    QString queryString;
    bool sqlOK;
    QString aux = QString();
...
bool DataProxy_SQLite::updateQSONumberPerLog()
{
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
            //qDebug() << Q_FUNC_INFO << " - TRUE2" << Qt::endl;
        query.finish();
        return false;
    }
    query.finish();
...
{
        //qDebug() << "DataProxy_SQLite::newDXMarathon" << Qt::endl;
    QSqlQuery query;
    QString queryString;
    bool sqlOK;
    ...
    if (sqlOK)
    {
        while(query.next())
        {
            if (query.isValid())
            {
                ...
                {
                         //qDebug() << "DataProxy_SQLite::newDXMarathon - Existing DXCC" << Qt::endl;
                    existingDXCC = true;
                }
                if ( (query.value(1)).toInt() == _cq)
                {
                        //qDebug() << "DataProxy_SQLite::newDXMarathon - Existing CQz" << Qt::endl;
                    existingCQz = true;
                }
        ...
        {
                //qDebug() << "DataProxy_SQLite::newDXMarathon - FALSE" << Qt::endl;
            query.finish();
            return false;
        }
        else
        {
                //qDebug() << "DataProxy_SQLite::newDXMarathon - TRUE1" << Qt::endl;
            query.finish();
            return true;
        }
    }
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
            //qDebug() << "DataProxy_SQLite::newDXMarathon - TRUE2" << Qt::endl;
        query.finish();
...
{
         //qDebug() << "DataProxy_SQLite::getContestNames() "  << Qt::endl;
    ...
    if (sqlOK)
    {
        while(query.next())
        {
            ...
            {
                queryString = (query.value(0)).toString();
                     //qDebug() << "DataProxy_SQLite::getContestNames: " << queryString  << Qt::endl;
...
{
         //qDebug() << "DataProxy_SQLite::getContestOverlays: "<< Qt::endl;
    ...
    if (sqlOK)
    {
        while(query.next())
        {
            ...
            {
                queryString = (query.value(0)).toString();
                     //qDebug() << "DataProxy_SQLite::getContestOverlays: " << queryString  << Qt::endl;
                contests.append(queryString);
            }
            else
            {
...
{
        //qDebug()  << "DataProxy_SQLite::getPropModeLists"  << Qt::endl;
    QString aux = QString();
    QStringList qs;
    qs.clear();
...
{
      //qDebug()  << "DataProxy_SQLite::addSatellite: " << QString::number(id)  << Qt::endl;
    QSqlQuery query;
    QString queryString;
    ...
    bool sqlOK = query.exec(queryString);
      //qDebug()  << "DataProxy_SQLite::addSatellite - query: " <<  query.lastQuery() << Qt::endl;

    if (sqlOK)
    {
          //qDebug()  << "DataProxy_SQLite::addSatellite - TRUE"  << Qt::endl;
          //qDebug()  << "DataProxy_SQLite::addSatellite - TRUE - ERROR: " <<  QString::number(query.lastError().nativeErrorCode()) << Qt::endl;
        query.finish();
        return true;
    }
    else
    {
          //qDebug()  << "DataProxy_SQLite::addSatellite - FALSE"  << Qt::endl;
...
{
      //qDebug()  << "DataProxy_SQLite::getDBSatId: " << _arrlId << Qt::endl;
 int aux = -1;
 ...
 if (sqlOK)
 {
     ...
     {
              //qDebug()  << "DataProxy_SQLite::getDBSatId:  query not valid"  << Qt::endl;
         query.finish();
     }
 }
 else
 {
          //qDebug()  << "DataProxy_SQLite::getSatelliteUplink:  query failed: " << query.lastQuery()  << Qt::endl;
     emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
     query.finish();
 }

      //qDebug()  << "DataProxy_SQLite::getSatelliteUplink: final: " << aux << Qt::endl;
 query.finish();
 return aux;
}
...
{
         //qDebug()  << "DataProxy_SQLite::getSatellitesList"  << Qt::endl;
     QString aux = QString();
     QStringList qs;
     qs.clear();
...
{
         //qDebug()  << "DataProxy_SQLite::getSatelliteUplink: " << _sat << Qt::endl;
    QString aux = QString();
    //QString aux2 = QString();
    //double fr1, fr2, fr;
    ...
    if (sqlOK)
    {
        ...
        {
                 //qDebug()  << "DataProxy_SQLite::getSatelliteUplink:  query not valid"  << Qt::endl;
            query.finish();
            return QString();
        }
    }
...
{
         //qDebug()  << "DataProxy_SQLite::getSatelliteDownlink: " << _sat << Qt::endl;
    QString aux = QString();
    //QString aux2 = QString();
    //double fr1, fr2, fr;
    ...
    if (sqlOK)
    {
        ...
        {
                 //qDebug()  << "DataProxy_SQLite::getSatelliteDownlink:  query not valid"  << Qt::endl;
            query.finish();
            return QString();
        }
    }
    ...
    {
             //qDebug()  << "DataProxy_SQLite::getSatelliteDownlink:  query failed: " << query.lastQuery()  << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return QString();
    }

         //qDebug()  << "DataProxy_SQLite::getSatelliteDownlink: final: " << aux << Qt::endl;
    query.finish();
    return aux;
}
...
QString DataProxy_SQLite::getSatelliteMode(const QString &_sat)
{
    ...
    if (sqlOK)
    {
        ...
        {
                 //qDebug()  << "DataProxy_SQLite::getSatelliteMode:  query not valid"  << Qt::endl;
            query.finish();
            return QString();
        }
    }
    ...
    {
             //qDebug()  << "DataProxy_SQLite::getSatelliteMode:  query failed: " << query.lastQuery()  << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return QString();
    }

         //qDebug()  << "DataProxy_SQLite::getSatelliteMode: final: " << aux << Qt::endl;
    return aux;
}

QString DataProxy_SQLite::getSatelliteFullUplink(const QString &_sat)
{
      //qDebug()  << "DataProxy_SQLite::getSatelliteFullUplink: " << _sat << Qt::endl;
 QString aux = QString();
 //QString aux2 = QString();
 //double fr1, fr2, fr;
 QString queryString = QString("SELECT uplink FROM satellites WHERE satarrlid='%1'").arg(_sat);
 ...
 if (sqlOK)
 {
     ...
     {
              //qDebug()  << "DataProxy_SQLite::getSatelliteFullUplink:  query not valid"  << Qt::endl;
         query.finish();
         return QString();
     }
 }
 ...
 {
          //qDebug()  << "DataProxy_SQLite::getSatelliteFullUplink:  query failed: " << query.lastQuery()  << Qt::endl;
     emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
     query.finish();
     return QString();
 }

      //qDebug()  << "DataProxy_SQLite::getSatelliteFullUplink: final: " << aux << Qt::endl;
 query.finish();
 return aux;
}
...
{
      //qDebug()  << "DataProxy_SQLite::getSatelliteFullDownlink: " << _sat << Qt::endl;
 QString aux = QString();
 //QString aux2 = QString();
 //double fr1, fr2, fr;
 QString queryString = QString("SELECT downlink FROM satellites WHERE satarrlid='%1'").arg(_sat);
 ...
 if (sqlOK)
 {
     ...
     {
              //qDebug()  << "DataProxy_SQLite::getSatelliteFullDownlink:  query not valid"  << Qt::endl;
         query.finish();
         return QString();
     }
 }
 ...
 {
          //qDebug()  << "DataProxy_SQLite::getSatelliteFullDownlink:  query failed: " << query.lastQuery()  << Qt::endl;
     emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
     query.finish();
     return QString();
 }

      //qDebug()  << "DataProxy_SQLite::getSatelliteFullDownlink: final: " << aux << Qt::endl;
 query.finish();
 return aux;
...
{
      //qDebug()  << "DataProxy_SQLite::getSatelliteName: " << _sat << Qt::endl;
 QString aux = QString();
 ...
 if (sqlOK)
 {
     ...
     {
              //qDebug()  << "DataProxy_SQLite::getSatelliteName:  query not valid"  << Qt::endl;
         query.finish();
         return QString();
     }
 }
 ...
 {
          //qDebug()  << "DataProxy_SQLite::getSatelliteName:  query failed: " << query.lastQuery()  << Qt::endl;
     emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
     query.finish();
     return QString();
 }

      //qDebug()  << "DataProxy_SQLite::getSatelliteName: final: " << aux << Qt::endl;
 query.finish();
 return aux;
}
...
QString DataProxy_SQLite::getSateliteArrlIdFromId(const int _id)
{
    ...
    if (sqlOK)
    {
        ...
        {
                 //qDebug()  << "DataProxy_SQLite::getSateliteArrlIdFromId:  query not valid"  << Qt::endl;
            query.finish();
            return QString();
        }
    }
    ...
    {
             //qDebug()  << "DataProxy_SQLite::getSateliteArrlIdFromId:  query failed: " << query.lastQuery()  << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return QString();
    }

         //qDebug()  << "DataProxy_SQLite::getSateliteArrlIdFromId: final: " << aux << Qt::endl;
    return aux;
...
{ //May even receive: 145.900-146.00 and should return the mid in the range (145.950)
         //qDebug()  << "DataProxy_SQLite::getFreqFromRange: " << _fr << Qt::endl;
    ...
    {   // Potentially somethink like: 435.030-435.456,146.180
        // We select the  first range
             ...
             //qDebug()  << "DataProxy_SQLite::getFreqFromRange: has several freqs: " << aux << Qt::endl;
        aux = aux.section(',', 0, 0);   // We select the first package
    ...
    if (aux.contains('-'))          // Potentially somethink like: 435.030-435.456
    {
        ...
        fr1 = aux.section('-', 0, 0);   // We select the first freq
             ...
             //qDebug()  << "DataProxy_SQLite::getFreqFromRange: fr1: " << fr1 << Qt::endl;
             //qDebug()  << "DataProxy_SQLite::getFreqFromRange: fr2: " << fr2 << Qt::endl;
        f1 = fr1.toDouble();
        f2 = fr2.toDouble();
             //qDebug()  << "DataProxy_SQLite::getFreqFromRange: f1: " << QString::number(f1) << Qt::endl;
             //qDebug()  << "DataProxy_SQLite::getFreqFromRange: f2: " << QString::number(f2) << Qt::endl;

        f1 = (f2 + f1)/2;

             //qDebug()  << "DataProxy_SQLite::getFreqFromRange: f1 after calc: " << QString::number(f1) << Qt::endl;
    }
    else
    {   // It is only one freq 145.950 so this is what must be returned
        f1 = aux.toDouble();
         ...
         //qDebug()  << "DataProxy_SQLite::getFreqFromRange: Return: " << QString::number(f1) << Qt::endl;
    return f1;
}

QStringList DataProxy_SQLite::getQSLRcvdList()
{
         //qDebug()  << "DataProxy_SQLite::getQSLRcvdList"  << Qt::endl;
     QString aux = QString();
     QStringList qs;
     qs.clear();
...
{
         //qDebug()  << "DataProxy_SQLite::getQSLSentList"  << Qt::endl;
     QString aux = QString();
     QStringList qs;
     qs.clear();
...
{
         //qDebug()  << "DataProxy_SQLite::getClubLogStatusList"  << Qt::endl;
     QString aux = QString();
     QStringList qs;
     qs.clear();
...
{
         //qDebug()  << "DataProxy_SQLite::getQSLViaList"  << Qt::endl;
     QString aux = QString();
     QStringList qs;
     qs.clear();
...
{
         //qDebug() << "DataProxy_SQLite::getContestNames: " << QString::number(_currentCat) <<"/" << QString::number(_lowerCat) << Qt::endl;
    QStringList contests = QStringList();
    QSqlQuery query;
    QString queryString;
    bool sqlOK;
...
{
         //qDebug() << "DataProxy_SQLite::haveAtLeastOneLog()" << Qt::endl;
    QSqlQuery query;
...
{
       //qDebug() << "DataProxy_SQLite::getColumnNamesFromTableLog" << Qt::endl;
    return getColumnNamesFromTable("log");
}

QStringList DataProxy_SQLite::getColumnNamesFromTable(const QString &_tableName)
{
       //qDebug() << "DataProxy_SQLite::getColumnNamesFromTable" << Qt::endl;
...
bool DataProxy_SQLite::setDXCCAwardStatus(const int _qsoId)
{
    ...
    // If not worked: Add and Return true
      ...
      //qDebug() << "DataProxy_SQLite::setDXCCAwardStatus: " << QString::number(_qsoId) << Qt::endl;
    if (_qsoId <= 0)
    {
           //qDebug() << "DataProxy_SQLite::setDXCCAwardStatus: QSOid <=0 " << QString::number(_qsoId) << Qt::endl;
        return false;
    }
    QList<int> values;
    values.clear();
    ...
    if (_dxcc <= 0)
    {
           //qDebug() << "DataProxy_SQLite::setDXCCAwardStatus: DXCC <= 0: DXCC: " << QString::number(_dxcc) << " - "  << QString::number(_qsoId) << Qt::endl;
        return false;
    }
    ...
    if (_band <= 0)
    {
          //qDebug() << "DataProxy_SQLite::setDXCCAwardStatus: Band <= 0: BAND: " << QString::number(_band) << " - "  << QString::number(_qsoId) << Qt::endl;
        return false;
    }
    ...
    if (_mode <= 0)
    {
          //qDebug() << "DataProxy_SQLite::setDXCCAwardStatus: Mode <= 0: Mode: " << QString::number(_mode) << " - "  << QString::number(_qsoId) << Qt::endl;
        return false;
    }
    ...
    if (_log <= 0)
    {
          //qDebug() << "DataProxy_SQLite::setDXCCAwardStatus: Log <= 0: Log: " << QString::number(_log) << " - "  << QString::number(_qsoId) << Qt::endl;
        return false;
    }
    ...
    bool sqlOK = query.exec(queryString);
      //qDebug() << "DataProxy_SQLite::setDXCCAwardStatus: Queryexec-1: " << queryString << Qt::endl;
    queryString.clear();
    ...
    if (sqlOK)
    {
        ...
        if (queryString.length()>5)
        {
            if (query.exec(queryString))
            {
                  //qDebug() << "DataProxy_SQLite::setDXCCAwardStatus: Queryexec-2: " << queryString << Qt::endl;
                query.finish();
                return true;
            }
...
bool DataProxy_SQLite::addDXCCEntitySubdivision(const QString &_name, const QString &_short, const QString &_pref,
                                                ...
                                                const bool _deleted)
{
    //qDebug() << "DataProxy_SQLite::addDXCCEntitySubdivision: length: " << _name << Qt::endl;
    // id / name / shortname / prefix / regionalgroup / regionalid / dxcc / cqz / ituz / start_date / end_date / deleted
    QString queryString;
    QSqlQuery query;
    bool sqlOK = false;

    //qDebug() << "DataProxy_SQLite::addRegionalAward: Importing: " << _regionalAward.getRegionalAwardRefName(i)  << Qt::endl;
    ...
    if (sqlOK)
    {
        //qDebug() << "DataProxy_SQLite::addRegionalAward: " << query.lastQuery() << Qt::endl;
        query.finish();
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::addRegionalAward: ERROR " << Qt::endl;
        //qDebug() << "DataProxy_SQLite::addRegionalAward: - query error: " << QString::number(query.lastError().nativeErrorCode()) << Qt::endl;
        //qDebug() << "DataProxy_SQLite::addRegionalAward: LastQuery: " << query.lastQuery()  << Qt::endl;
        //qDebug() << "DataProxy_SQLite::addRegionalAward: LastError-data: " << query.lastError().databaseText()  << Qt::endl;
        //qDebug() << "DataProxy_SQLite::addRegionalAward: LastError-driver: " << query.lastError().driverText()  << Qt::endl;
        //qDebug() << "DataProxy_SQLite::addRegionalAward: LastError-n: " << QString::number(query.lastError().nativeErrorCode() ) << Qt::endl;

        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return false;
    }
    //qDebug() << "DataProxy_SQLite::addDXCCEntitySubdivision: END"  << Qt::endl;
    return true;
}
...
{
         //qDebug() << "DataProxy_SQLite::getNumberOfManagedLogs" << Qt::endl;
    QSqlQuery query;
...
QStringList DataProxy_SQLite::getListOfManagedLogs()
{
    //This function returns the list of log IDs that are being managed
         //qDebug() << "DataProxy_SQLite::getListOfManagedLogs" << Qt::endl;
    QSqlQuery query;
    QStringList qs;
    qs.clear();
        ...
        while (query.next())
        {
            if (query.isValid())
            {
                qs << (query.value(0)).toString();
                     //qDebug() << "DataProxy_SQLite::getListOfManagedLogs: " << (query.value(0)).toString()  << Qt::endl;
            }
        }
    }
    else
...
{
         //qDebug() << "DataProxy_SQLite::getStationCallSignFromLog: " << QString::number(_log)<< Qt::endl;
    QSqlQuery query;
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
                 //qDebug() << "DataProxy_SQLite::getStationCallSignFromLog: " <<  (query.value(0)).toString() << Qt::endl;
            QString v = (query.value(0)).toString();
            query.finish();
            return v;
        }
        ...
        {
                 //qDebug() << "DataProxy_SQLite::getStationCallSignFromLog: Not valid" << Qt::endl;
            query.finish();
            return QString();
        }
    }
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
             //qDebug() << "DataProxy_SQLite::getStationCallSignFromLog: query failed" << Qt::endl;
        query.finish();
        return QString();
    }

         //qDebug() << "DataProxy_SQLite::getStationCallSignFromLog: END" << Qt::endl;
    //return QString();
...
{
    //qDebug() << "DataProxy_SQLite::getStationCallSignsFromLog" << Qt::endl;
           ...
           if (query.isValid())
           {
               ...
               if (queryString.length()>2)
               {
                   calls.append(queryString);
                    ...
                    //qDebug() << "DataProxy_SQLite::getStationCallSignsFromLog: " << queryString << Qt::endl;

           }
           else
           {
               query.finish();
               //qDebug() << "DataProxy_SQLite::getStationCallSignsFromLog-END-1 - fail" << Qt::endl;
               return QStringList();
           }
   ...
   else
   {
       emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
       query.finish();
       //qDebug() << "DataProxy_SQLite::getStationCallSignsFromLog-END-2 - fail" << Qt::endl;
       return QStringList();
   }
   calls.sort();
   //qDebug() << "DataProxy_SQLite::getStationCallSignsFromLog-END" << Qt::endl;
   return calls;
}
...
{
    //qDebug() << "DataProxy_SQLite::getOperatorsFromLog: " << QString::number(_log)<< Qt::endl;
    QSqlQuery query;
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
               //qDebug() << "DataProxy_SQLite::getOperatorsFromLog: " <<  (query.value(0)).toString() << Qt::endl;
            QString v = (query.value(0)).toString();
            query.finish();
            return v;
        }
        ...
        {
               //qDebug() << "DataProxy_SQLite::getOperatorsFromLog: Not valid" << Qt::endl;
            query.finish();
            return QString();
        }
    }
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
           //qDebug() << "DataProxy_SQLite::getOperatorsFromLog: query failed" << Qt::endl;
        query.finish();
        return QString();
    }

  //qDebug() << "DataProxy_SQLite::getOperatorsFromLog: END" << Qt::endl;
  //return QString();
}

QString DataProxy_SQLite::getCommentsFromLog(const int _log)
{
       //qDebug() << "DataProxy_SQLite::getLogDateFromLog: " << QString::number(_log)<< Qt::endl;
  QSqlQuery query;
  ...
  if (sqlOK)
  {
      ...
      if (query.isValid())
      {
               //qDebug() << "DataProxy_SQLite::getCommentsFromLog: " <<  (query.value(0)).toString() << Qt::endl;
          QString v = (query.value(0)).toString();
          query.finish();
          return v;
      }
      ...
      {
               //qDebug() << "DataProxy_SQLite::getCommentsFromLog: Not valid" << Qt::endl;
          query.finish();
          return QString();
      }
  }
  ...
  {
      emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
           //qDebug() << "DataProxy_SQLite::getLogDateFromLog: query failed" << Qt::endl;
      query.finish();
      return QString();
  }

       //qDebug() << "DataProxy_SQLite::getCommentsFromLog: END" << Qt::endl;
  //return QString();
}
...
QString DataProxy_SQLite::getLogDateFromLog(const int _log)
{
  ...
  if (sqlOK)
  {
      ...
      if (query.isValid())
      {
               //qDebug() << "DataProxy_SQLite::getLogDateFromLog: " <<  (query.value(0)).toString() << Qt::endl;
          QString v = (query.value(0)).toString();
          query.finish();
          return v;
      }
      ...
      {
               //qDebug() << "DataProxy_SQLite::getLogDateFromLog: Not valid" << Qt::endl;
          query.finish();
          return QString();
      }
  }
  else
  {
      ...
      return QString();
       ...
       //qDebug() << "DataProxy_SQLite::getLogDateFromLog: END" << Qt::endl;
  //return QString();
}
...
{
    //qDebug() << "DataProxy_SQLite::fillEmptyDXCCInTheLog"  << Qt::endl;
        ...
        while (query.next())
        {
            if (query.isValid())
            {
                ...
                _continent = getContinentShortNameFromEntity(_dxcc.toInt());
                   //qDebug() << "DataBase::fillEmptyDXCCInTheLog: DXCC: " << _dxcc << Qt::endl;
                   //qDebug() << "DataBase::fillEmptyDXCCInTheLog: Cont: " << _continent << Qt::endl;
                ...
                {
                       //qDebug() << "DataBase::fillEmptyDXCCInTheLog: progress canceled" << Qt::endl;
                    query.finish();
                    return true;
                }
                j++;
...
{
       //qDebug() << "DataProxy_SQLite::getQSOsWithContinent: " << _cont << Qt::endl;
    QSqlQuery query;
    QString queryString;
    bool sqlOK;
    if (_logNumber < 0)
    ...
    sqlOK = query.exec(queryString);
         ...
         //qDebug() << "DataProxy_SQLite::getQSOsWithContinent: queryString: " << queryString << Qt::endl;
    if (sqlOK)
    {
        query.next();
        if (query.isValid())
        {
                 //qDebug() << "DataProxy_SQLite::getQSOsWithContinent: " << QString::number((query.value(0)).toInt()) << Qt::endl;
            int v = (query.value(0)).toInt();
            query.finish();
            return v;
        }
        ...
        {
                 //qDebug() << "DataProxy_SQLite::getQSOsWithContinent: 0" << Qt::endl;
            query.finish();
            return 0;
        }
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
             //qDebug() << "DataProxy_SQLite::getQSOsWithContinent: Query error" << Qt::endl;
        query.finish();
        return 0;
    }
}
...
{
    //qDebug() << Q_FUNC_INFO << " : " << QString::number(_log) << Qt::endl;
...
{
        //qDebug() << "DataProxy_SQLite::addNewLog: " << _qs.at(2) << "/" << _qs.at(5) << "/" << _qs.at(6) << Qt::endl;
      //qDebug() << "DataProxy_SQLite::addNewLog: Size: " << QString::number(_qs.size()) << Qt::endl;
    // newLogq << dateString << stationCallsign << operators << comment << QString::number(selectedLog) << _qs.at(4) ; (last field is 1 or 0 editing)

    if (_qs.size()!=6)
    {
          //qDebug() << "DataProxy_SQLite::addNewLog: != 6"  << Qt::endl;
        return false;
    }
      //qDebug() << "DataProxy_SQLite::addNewLog: Has the appropriate length"  << Qt::endl;
    ...
    //_operators.clear();
    //_operators << (_qs.at(2)).split(',', Qt::SkipEmptyParts);
    ...
    if (editing == "1")
    { // We are editing
            //qDebug() << "DataProxy_SQLite::addNewLog: We are editing!" << Qt::endl;
        ...
        if (sqlOK)
        {
                //qDebug() << "DataProxy_SQLite::addNewLog: Editing OK!" << Qt::endl;
            query.finish();
            return true;
        }
        else
        {
                //qDebug() << "DataProxy_SQLite::addNewLog: Editing NOK!" << Qt::endl;
            emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
            query.finish();
            return false;
        }
        ...
        //qDebug() << "DataProxy_SQLite::addNewLog: We are adding a new log" << Qt::endl;
    ...
    //qDebug() << "DataProxy_SQLite::addNewLog query1: " << queryString << Qt::endl;
    ...
    if (sqlOK)
    {
        ...
        if (query.isValid())
        {
            //qDebug() << "DataProxy_SQLite::addNewLog query error: " << queryString << Qt::endl;
...
{
       //qDebug() << "DataProxy_SQLite::doesThisLogExist: " << QString::number(_log) << Qt::endl;
       //qDebug() << "DataProxy_SQLite::doesThisLogExist - Name:" << db->getDBName() << Qt::endl;
    QSqlQuery query;

    QString queryString = QString("SELECT id FROM logs WHERE id='%1'").arg(_log);
    bool sqlOK = query.exec(queryString);

       //qDebug() << "DataProxy_SQLite::doesThisLogExist: query: " << query.lastQuery()  << Qt::endl;
    ...
    if (sqlOK)
    {
        if (query.next())
        {
            ...
            {
                query.finish();
                   //qDebug() << "DataProxy_SQLite::doesThisLogExist: END TRUE"  << Qt::endl;
                return true;
            }
            else
            {
                query.finish();
                   //qDebug() << "DataProxy_SQLite::doesThisLogExist: END FALSE 1"  << Qt::endl;
                return false;
            }
        }
        else
        {
            query.finish();
               //qDebug() << "DataProxy_SQLite::doesThisLogExist: END FALSE 2"  << Qt::endl;
            return false;
        }
    }
    else
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
           //qDebug() << "DataProxy_SQLite::doesThisLogExist: END FALSE 3"  << Qt::endl;
        return false;
    }
       //qDebug() << "DataProxy_SQLite::doesThisLogExist: END FALSE 4"  << Qt::endl;
    //return false;
}
...
{
    //qDebug() << "DataProxy_SQLite::getEntityNameFromId: " << QString::number(_n) << Qt::endl;
...
{
    //qDebug() << "DataProxy_SQLite::getEntityIdFromName:" << _e << Qt::endl;
...
{
        //qDebug() << "DataProxy_SQLite::getEntityMainPrefix:" << QString::number(_entityN) << Qt::endl;
...
int DataProxy_SQLite::getEntityIdFromMainPrefix(const QString &_e)
{
      ...
      //qDebug() << "DataProxy_SQLite::getEntityIdFromMainPrefix:" << _e << Qt::endl;
...
{
      //qDebug() << "DataProxy_SQLite::getDXCCFromPrefix - " << Q_FUNC_INFO << "-" << _p << "-" << Qt::endl;
    ...
    if (sqlOK)
    {
          //qDebug() << "DataProxy_SQLite::getDXCCFromPrefix: query OK: query: " << queryString << Qt::endl;
        if (query.next())
        {
            if (query.isValid())
            {
                int v = (query.value(0)).toInt();
                query.finish();
                  //qDebug() << "DataProxy_SQLite::getDXCCFromPrefix: return 0: " << QString::number(v)  << Qt::endl;
                return v;
            }
            else
            {
                query.finish();
                  //qDebug() << "DataProxy_SQLite::getDXCCFromPrefix: return -1: " << Qt::endl;
                return -1;
            }
        }
        else
        {
            query.finish();
              //qDebug() << "DataProxy_SQLite::getDXCCFromPrefix: return -2: " << Qt::endl;
            return -2;
        }
    }
    else
    {
          //qDebug() << "DataProxy_SQLite::getDXCCFromPrefix: query NOK: query: " << queryString << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
          //qDebug() << "DataProxy_SQLite::getDXCCFromPrefix: return -3: " << Qt::endl;
        return -3;
    }
    //return -4;
}
...
{
         //qDebug()  << "DataProxy_SQLite::getEntitiesNames"  << Qt::endl;
    QString aux = QString();
    QStringList qs;
    qs.clear();
        ...
        while ( (query.next())) {
            if (query.isValid())
            {
                dxcc = query.value(2).toInt();
                    //qDebug()  << "DataProxy_SQLite::getEntitiesNames - DXCC: " <<  QString::number(dxcc) << Qt::endl;
                if (dxcc > 1000)
                {
                        //qDebug()  << "DataProxy_SQLite::getEntitiesNames - DXCC>1000 going in details: " << Qt::endl;

                    aux2 = QString::number(dxcc);
                    aux2 = aux2.right(3);
                        //qDebug()  << "DataProxy_SQLite::getEntitiesNames - aux2: " <<  aux2 << Qt::endl;
                ...
                {
                        //qDebug()  << "DataProxy_SQLite::getEntitiesNames - DXCC<1000 quick! " << Qt::endl;
                    aux.clear();
                    aux = (query.value(0)).toString() + "-" + (query.value(1)).toString()+" ("+QString::number(dxcc)+")";

                }

                        //qDebug()  << "DataProxy_SQLite::getEntitiesNames - AUX: " << aux << Qt::endl;
                //result = result + ", " + (query.value(0)).toString();
                qs << aux;
            }
            else
...
{
       //qDebug()  << "DataProxy_SQLite::updateISONames"  << Qt::endl;
    bool result;
...
{
    //qDebug()  << "DataProxy_SQLite::getISONames: " << QString::number(_n)  << Qt::endl;
    if (_n <= 0 )
    {
             //qDebug()  << "DataProxy_SQLite::getISONames: NOT KNOWN - UN" << Qt::endl;
    ...
    {
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
            //qDebug()  << "DataProxy_SQLite::getISOName: Query error - UN"  << Qt::endl;
        query.finish();
        return "un"; // When no flag is known, we return the UN flag
    }
    else
    {
        ...
        if (query.isValid()){
            //qDebug()  << "DataProxy_SQLite::getISOName: " << "N: " << QString::number(_n) << "- ISO Name: " << (query.value(0)).toString() << Qt::endl;
            aux = (query.value(0)).toString();
            query.finish();
            if (aux.length()>1)
            {
        ...
        {
                  //qDebug()  << "DataProxy_SQLite::getISOName: NO ISO Name: "  << Qt::endl;
            query.finish();
            return "un"; // When no flag is known, we return the UN flag
        }
    }
         //qDebug()  << "DataProxy_SQLite::getISOName: NO ISO Name: default"  << Qt::endl;
    //return "un"; // When no flag is known, we return the UN flag
}

/*void DataProxy_SQLite::getFoundInLog(const QString &_txt, const int _log)
{
         //qDebug()  << "DataProxy_SQLite::getFoundInLog: " << _txt << "/" << QString::number(_log)  << Qt::endl;
    ...
    if (_txt.length()<2)
    {
             //qDebug()  << "DataProxy_SQLite::getFoundInLog: lengh shorter than 2"  << Qt::endl;
        searching = false;
        return;
    }

         //qDebug()  << "DataProxy_SQLite::getFoundInLog: let's go searching!"  << Qt::endl;
    if (_log <= 0)
    {
    ...
    if (sqlOk)
    {
             //qDebug()  << "DataProxy_SQLite::getFoundInLog: Query OK"  << Qt::endl;
        QSqlRecord rec = query.record();
        int nameCol = -1;
        int counter = 0;
        while ((query.next()) && (searching))
        {
            ...
            {
                counter++;
                     //qDebug()  << "DataProxy_SQLite::getFoundInLog: Data found: - "  << QString::number(counter) << Qt::endl;
                qsoDataFound.clear();

                nameCol = rec.indexOf("call");
                qsoDataFound << "call:" + (query.value(nameCol)).toString();
                     //qDebug()  << "DataProxy_SQLite::getFoundInLog: Data found: " << (query.value(nameCol)).toString() << Qt::endl;
                ...
                if (qsoDataFound.length()>1)
                {
                 emit qsoFound(qsoDataFound);
                      //qDebug()  << "DataProxy_SQLite::getFoundInLog: Emitting qsoDataFound... (exec: "<< QString::number(executionN) << ") Call-id: " << qsoDataFound.at(0)  << "-" << qsoDataFound.at(8) << Qt::endl;
                }
                else
                {
                         //qDebug()  << "DataProxy_SQLite::getFoundInLog: NOT emitting qsoDataFound... (exec: "<< QString::number(executionN) << ")" << Qt::endl;
                         //qDebug()  << "DataProxy_SQLite::getFoundInLog: NOT Emitting qsoDataFound..."  << Qt::endl;
                }

            } // Closes if next.isValid
        } // Closes While
             //qDebug()  << "DataProxy_SQLite::getFoundInLog: No more data!"  << Qt::endl;
        return;
    }
    else
    {
             //qDebug()  << "DataProxy_SQLite::getFoundInLog: Error 1: Query NOK"  << Qt::endl;
        searching = false;
      return;
    }
         //qDebug()  << "DataProxy_SQLite::getFoundInLog: Error 2"  << Qt::endl;
    searching = false;
    return;
...
{
       //qDebug()  << "DataProxy_SQLite::queryPrepare: " << _query << Qt::endl;
...
{
       //qDebug()  << "DataProxy_SQLite::queryBind: " << _field << "/" << value << Qt::endl;
...
{
       //qDebug()  << "DataProxy_SQLite::queryExec  "  << Qt::endl;
    ...
    if (!sqlOK)
    {
        //emit queryError(Q_FUNC_INFO, preparedQuery.lastError().databaseText(), preparedQuery.lastError().nativeErrorCode(), preparedQuery.lastQuery());
           //qDebug()  << "DataProxy_SQLite::queryExec - FAILED execution "   << Qt::endl;
    }
    else
    {
           //qDebug()  << "DataProxy_SQLite::queryExec - executed "  << Qt::endl;
    }
    return sqlOK;
}
*/
...
{
       //qDebug() << "DataProxy_SQLite::getPrefixId: -" << _qrz <<"-" << Qt::endl;
    ...
    while ((entityID <= 0) && (aux.length()>=1) )
    {
        entityID = getDXCCFromPrefix(aux);
            ...
            //qDebug() << "DataProxy_SQLite::getPrefixId: in the while" << aux << " = " <<  QString::number(entityID) << Qt::endl;
         if (entityID<=0)
         {
             aux.chop(1);
         }
        ...
        //qDebug() << "DataProxy_SQLite::getPrefixId: " <<  _qrz << QString::number(entityID) << Qt::endl;
    return entityID;
}

QString DataProxy_SQLite::changeSlashAndFindPrefix(const QString &_qrz)
{
       //qDebug() << "DataProxy_SQLite::changeSlashAndFindPrefix: -"  << _qrz <<"-" << Qt::endl;
    int iaux1, iaux2;
    ...
    if (aux.count('/')) // / found! Checking different options
    {
        ...
        iaux1 = aux.indexOf('/');
            //qDebug() << "DataProxy_SQLite::changeSlashAndFindPrefix: Slash found at: "  << QString::number(iaux1) << Qt::endl;
...
QString DataProxy_SQLite::getADIFQSO(const int _qsoId)
{
    ...
    //qDebug() << "DataProxy_SQLite::getADIFQSO: " <<  QString::number(_qsoId) << Qt::endl;
    int nameCol;
    QString aux;
    ...
    if (sqlOk)
    {
        if (query.next())
        {
            if (query.isValid())
            {
              //qDebug() << "DataProxy_SQLite::getADIFQSO: Query OK: " << query.lastQuery() << Qt::endl;
            }
            else
            {
                //qDebug() << "DataProxy_SQLite::getADIFQSO: Query isValid FAILED: " << query.lastQuery() << Qt::endl;
                query.finish();
                return QString();
            }
        ...
        {
            //qDebug() << "DataProxy_SQLite::getADIFQSO: Query NEXT FAILED: " << query.lastQuery() << Qt::endl;
            query.finish();
            return QString();
        }
    }
    ...
    {
        //qDebug() << "DataProxy_SQLite::getADIFQSO: Query FAILED: " << query.lastQuery() << Qt::endl;
        query.finish();
        return QString();
    }
    QSqlRecord rec = query.record();
    ...
    if (nameCol>=0)
    {
        ...
        //qDebug() << "DataProxy_SQLite::getADIFQSO: " << QString::number(nameCol) << "/" << aux1 << Qt::endl;
    ...
    if (nameCol>=0)
    {
        ...
        //qDebug() << "DataProxy_SQLite::getADIFQSO: PROP_MODE"  << Qt::endl;
    }
    ...
    //qDebug() << "DataProxy_SQLite::getADIFQSO: SAT_NAME"  << Qt::endl;
    }
    ...
    {
        aux = (query.value(nameCol)).toString();
        //qDebug() << "DataProxy_SQLite::getADIFQSO: StationCallSign: " << aux  << Qt::endl;
        if ((util->isValidCall(aux)))
    ...
    //qDebug() << "DataProxy_SQLite::getADIFQSO - 100" << Qt::endl;
    nameCol = rec.indexOf("cqz");
    if (nameCol>=0)
    {
        aux = (query.value(nameCol)).toString(); aux = util->checkAndFixASCIIinADIF(aux);
    ...
    if (nameCol>=0)
    {
        ...
        //qDebug() << "DataProxy_SQLite::getADIFQSO: DXCC - Now..."  << Qt::endl;
    }
    nameCol = rec.indexOf("dxcc");
    if (nameCol>=0)
    {
        ...
        if ((aux.length())>0)
        {
            ...
            //qDebug() << "DataProxy_SQLite::getADIFQSO: DXCC " << aux << Qt::endl;
        }
        //qDebug() << "DataProxy_SQLite::getADIFQSO: DXCC - Exported!"  << Qt::endl;
    }
    ...
    if (nameCol>=0)
    {
        ...
        //qDebug() << "DataProxy_SQLite::getADIFQSO - 200" << Qt::endl;
    }
    ...
    //qDebug() << "DataProxy_SQLite::getADIFQSO - 30" << Qt::endl;
    ...
    if (nameCol>=0)
    {
        ...
        //qDebug() << "DataProxy_SQLite::getADIFQSO - 40" << Qt::endl;
    }
    ...
    {
        aux = (query.value(nameCol)).toString(); aux = util->checkAndFixASCIIinADIF(aux);
        //qDebug() << "DataProxy_SQLite::getADIFQSO (IOTA): " << aux << Qt::endl;
    ...
    {
        aux = (query.value(nameCol)).toString(); aux = util->checkAndFixASCIIinADIF(aux);
        //qDebug() << "DataProxy_SQLite::getADIFQSO (IOTA_ID): " << aux << Qt::endl;
        if ((aux.length())>0)
        {
...
QList<QSO*> DataProxy_SQLite::getSatDXCCStats(int _log)
{
    ...
    if (doesThisLogExist(_log))
    {
        //qDebug() << Q_FUNC_INFO << ": log exists "  << Qt::endl;
    ...
    {
        //qDebug() << Q_FUNC_INFO << ": log does not exist "  << Qt::endl;
    ...
    if (!sqlOK)
    {
        //qDebug() << Q_FUNC_INFO << ":  Query NOK" << Qt::endl;
        //qDebug() << Q_FUNC_INFO << ":  " << query.lastError().databaseText() << Qt::endl;
        //qDebug() << Q_FUNC_INFO << ":  " << query.lastQuery() << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return _qsos;
    ...
    else
    {
        while(query.next())
        {
            if (query.isValid())
            {
                ...
                nameCol = rec.indexOf("bandid");
                //qDebug() << "DataProxy_SQLite::getGridStats: bandid" << QString::number((query.value(nameCol)).toInt()) << Qt::endl;
                _qso->setBand(query.value(2).toString());

                //nameCol = rec.indexOf("modeid");
                //qDebug() << Q_FUNC_INFO << ": modeid" << QString::number((query.value(nameCol)).toInt()) << Qt::endl;
    ...
    else
    {
        while(query.next())
        {
            ...
            {// call, substr(gridsquare, 1, 4), bandid, modeid, lotw_qsl_rcvd, qsl_rcvd
                ...
                nameCol = rec.indexOf("bandid");
                //qDebug() << Q_FUNC_INFO <<  ": bandid" << QString::number((query.value(nameCol)).toInt()) << Qt::endl;
                ...
                _qsos.append(_qso);
                //qDebug() << Q_FUNC_INFO <<  ": call: " << _call << Qt::endl;
        ...
        //qDebug() << "DataProxy_SQLite::addQSO:  Query OK" << Qt::endl;
    }

    //qDebug() << "DataProxy_SQLite::getGridStats - END" << Qt::endl;
    return _qsos;
}

QList<QSO *> DataProxy_SQLite::getSatGridStats(int _log)
{
    //qDebug() << "DataProxy_SQLite::getGridStats: log = " << QString::number(_log) << Qt::endl;

    QList<QSO*> _qsos;
    QString stringQuery;
    if (doesThisLogExist(_log))
    {
        //qDebug() << "DataProxy_SQLite::getGridStats: log exists "  << Qt::endl;
    ...
    {
        //qDebug() << "DataProxy_SQLite::getGridStats: log does not exist "  << Qt::endl;
    ...
    if (!sqlOK)
    {
        //qDebug() << "DataProxy_SQLite::getGridStats:  Query NOK" << Qt::endl;
        //qDebug() << "DataProxy_SQLite::getGridStats:  " << query.lastError().databaseText() << Qt::endl;
        //qDebug() << "DataProxy_SQLite::getGridStats:  " << query.lastQuery() << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        query.finish();
        return _qsos;
    }
    else
    {
        while(query.next())
        {
            if (query.isValid())
            {
                ...
                nameCol = rec.indexOf("modeid");
                //qDebug() << "DataProxy_SQLite::getGridStats: modeid" << QString::number((query.value(nameCol)).toInt()) << Qt::endl;
                _qso->setMode(getNameFromModeId((query.value(nameCol)).toInt()));
                ...
                _qsos.append(_qso);
                //qDebug() << "DataProxy_SQLite::getGridStats: call: " << _call << Qt::endl;
                //qDebug() << "DataProxy_SQLite::getGridStats: band: " << _band << Qt::endl;
                //qDebug() << "DataProxy_SQLite::getGridStats: mode: " << _mode << Qt::endl;
...
int DataProxy_SQLite::getFieldInBand(ValidFieldsForStats _field, const QString &_band, bool confirmedOnly, QString _mode, int _log)
{
   ...
   else
   {
    ...
    else
    {
        ...
        if (query.isValid())
        {
            //qDebug() << Q_FUNC_INFO << " : " << QString::number((query.value(0)).toInt()) << Qt::endl;
            int v = (query.value(0)).toInt();
            query.finish();
            return v;
        }
...
{
   //qDebug() << "DataProxy_SQLite::addQSO: " << _qso.getCall() << Qt::endl;
    qso = &_qso;
   //qDebug() << "DataProxy_SQLite::addQSO: " << qso->getCall() << Qt::endl;
    //qso = _qso;
   ...
   //qDebug() << "DataProxy_SQLite::addQSO: QDateTime: " << util->getDateTimeSQLiteStringFromDateTime(qso->getDateTimeOn())  << Qt::endl;
    ...
    {
        //qDebug() << "DataProxy_SQLite::addQSO:  END-1" << Qt::endl;
        return -1;
    }
    ...
    {
       //qDebug() << "DataProxy_SQLite::addQSO:  END-2" << Qt::endl;
        return -2;
    }
   //qDebug() << "DataProxy_SQLite::addQSO: Band: " << qso->getBand() << Qt::endl;
    ...
    {
       //qDebug() << "DataProxy_SQLite::addQSO:  END-3" << Qt::endl;
        return -3;
    }
    ...
    {
       //qDebug() << "DataProxy_SQLite::addQSO:  END-4" << Qt::endl;
        return -4;
    }
    ...
    //qDebug() << "DataProxy_SQLite::addQSO:  getQSL_RCVD: " << qso->getQSL_RCVD() << Qt::endl;
    if (util->isValidQSL_Rcvd(qso->getQSL_RCVD()))
    {
        //qDebug() << "DataProxy_SQLite::addQSO:  getQSL_RCVD: VALID "  << Qt::endl;
        stringFields.append("qsl_rcvd, ");
        stringData = stringData + "'" + qso->getQSL_RCVD() + "', ";
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::addQSO:  getQSL_RCVD: NOT valid"  << Qt::endl;
    }
    //qDebug() << "DataProxy_SQLite::addQSO:  LOTW_QSL_RCVD: " << qso->getLoTWQSL_RCVD()  << Qt::endl;
    if (util->isValidQSL_Rcvd(qso->getLoTWQSL_RCVD()))
    {
        //qDebug() << "DataProxy_SQLite::addQSO:  LOTW_QSL_RCVD - VALID"  << Qt::endl;
        stringFields.append("lotw_qsl_rcvd, ");
        stringData = stringData + "'" + qso->getLoTWQSL_RCVD() + "', ";
    }
    else
    {
        //qDebug() << "DataProxy_SQLite::addQSO:  LOTW_QSL_RCVD - NOT valid"  << Qt::endl;
    }
    //qDebug() << "DataProxy_SQLite::addQSO:  LOTW_QSL_RCVD - END"  << Qt::endl;
    ...
    {
       //qDebug() << "DataProxy_SQLite::addQSO: No LogNumber" << Qt::endl;
        return -2;
    }
    ...
    if (!sqlOK)
    {
       //qDebug() << "DataProxy_SQLite::addQSO:  Query NOK" << Qt::endl;
       //qDebug() << "DataProxy_SQLite::addQSO:  " << query.lastError().databaseText() << Qt::endl;
       //qDebug() << "DataProxy_SQLite::addQSO:  " << query.lastQuery() << Qt::endl;
        emit queryError(Q_FUNC_INFO, query.lastError().databaseText(), query.lastError().nativeErrorCode(), query.lastQuery());
        return -1;
    }
    else
   ...
   //qDebug() << "DataProxy_SQLite::addQSO: " << stringQuery << Qt::endl;
    return getLastQSOid();
