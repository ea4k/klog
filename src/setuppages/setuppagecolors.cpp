...
SetupPageColors::SetupPageColors(QWidget *parent) : QWidget(parent)
{
    ...
    QHBoxLayout *WSJTXColorsLayout = new QHBoxLayout;
    WSJTXColorsLayout->addWidget(wsjtxColorButton);
    WSJTXColorsLayout->addWidget(klogColorButton);

    QHBoxLayout *schemasLayout = new QHBoxLayout;
    schemasLayout->addLayout (WSJTXColorsLayout);
