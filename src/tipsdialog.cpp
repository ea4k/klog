...
void TipsDialog::setTip(const int _t)
{
   ...
   case 2:
    ...
    break;
    case 12:
        description = tr("<b>Tip #12:</b><br>Do you know...<br>You can subscribe to <a href=https://t.me/klogdevel>KLog-devel telegram group</a> to discuss about KLog development in English?");
    break;
    case 13:
