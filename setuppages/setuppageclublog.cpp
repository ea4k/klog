...
SetupPageClubLog::SetupPageClubLog(QWidget *parent) : QWidget(parent)
{
    ...
    warningLabel->setText(tr("Please know that the Station Callsign of each QSO will be used to used to upload the QSO to the proper Clublog log."));
    warningLabel->setFrameStyle(QFrame::StyledPanel | QFrame::Raised);
    ...
    //glayout->addWidget(warningLabel, 0, 0, -1, 0);
  //  glayout->addWidget(callLabel, 0, 0);
    ...
    glayout->addWidget(emailLineEdit, 0, 1);
    glayout->addWidget(passwordLineEdit, 1, 1);
    ...
    connect(passwordLineEdit, SIGNAL(returnPressed()), this, SLOT(slotEnterKeyPressed() ) );
    //connect(callLineEdit, SIGNAL(returnPressed()), this, SLOT(slotEnterKeyPressed() ) );
    connect(emailLineEdit, SIGNAL(returnPressed()), this, SLOT(slotEnterKeyPressed() ) );
...
void SetupPageClubLog::slotEnterKeyPressed()
{
    emit enterKey();
}
